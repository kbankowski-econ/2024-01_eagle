...
dynare('load0.mod', sprintf('-I%s/%s/submodules', project_path, 'eagleParsingTemp_sim_BIG1'), 'savemacro');

%% non-SS version of the model
dynare('eagleModel.mod', sprintf('-I%s/%s/submodules', project_path, 'eagleParsingTemp_sim_BIG1'), 'savemacro');

%%
dynare('steady0.mod', sprintf('-I%s/%s/submodules', project_path, 'eagleParsingTemp_sim_BIG1'), 'savemacro');

%% 
dynare('steady1.mod', sprintf('-I%s/%s/submodules', project_path, 'eagleParsingTemp_sim_BIG1'), 'savemacro');
...
%%
dynare('steady2.mod', sprintf('-I%s/%s/submodules', project_path, 'eagleParsingTemp_sim_BIG1'), 'savemacro');

%%
replaceInTextFile( ...
    fullfile(project_path, "eagleParsingTemp_sim_BIG1", "submodules", "modeqs.mod") ...
    , fullfile(project_path, "eagleParsingTemp_sim_BIG1", "submodules", "modeqs_govCo.mod") ...
...
appendTextFile( ...
    fullfile(project_path, "eagleParsingTemp_sim_BIG1", "submodules", "symdecls.mod"), ...
    fullfile(project_path, "eagleParsingTemp_sim_BIG1", "submodules", "symdecls_govCo.mod"), ...
    linesToAppend ...
);

steady2output = load(fullfile(project_path, 'eagleParsingTemp_sim_BIG1', 'modFiles', 'steady2', 'Output', 'steady2_results.mat'));
...
filename = fullfile(project_path, 'eagleParsingTemp_sim_BIG1', 'modFiles', 'eagle_steady_govCo_stage0.txt');
...
dynare('steady3.mod', sprintf('-I%s/%s/submodules', project_path, 'eagleParsingTemp_sim_BIG1'), 'savemacro');

%%
replaceInTextFile( ...
    fullfile(project_path, "eagleParsingTemp_sim_BIG1", "submodules", "modeqs_govCo.mod") ...
    , fullfile(project_path, "eagleParsingTemp_sim_BIG1", "submodules", "modeqs_govInv.mod") ...
...
appendTextFile( ...
    fullfile(project_path, "eagleParsingTemp_sim_BIG1", "submodules", "symdecls_govCo.mod"), ...
    fullfile(project_path, "eagleParsingTemp_sim_BIG1", "submodules", "symdecls_govInv.mod"), ...
    linesToAppend ...
);

steady3output = load(fullfile(project_path, 'eagleParsingTemp_sim_BIG1', 'modFiles', 'steady3', 'Output', 'steady3_results.mat'));
...
% Specify the output file name
filename = fullfile(project_path, 'eagleParsingTemp_sim_BIG1', 'modFiles', 'eagle_steady_govInv_stage0.txt');
% Open the file for writing
fileID = fopen(filename, 'w');
% Check if the file was opened successfully
if fileID == -1
...
dynare('steady4.mod', sprintf('-I%s/%s/submodules', project_path, 'eagleParsingTemp_sim_BIG1'), 'savemacro');

%%
dynare('steady5.mod', sprintf('-I%s/%s/submodules', project_path, 'eagleParsingTemp_sim_BIG1'), 'savemacro');
