...
% (4)
As in other large-scale DSGE models, our framework incorporates non-Ricardian households and several real and nominal rigidities, including habit formation, investment and import adjustment costs, and Calvo-type pricing of intermediate goods and wages with partial indexation. Owing to the substantial scale of the model (approximately 9,999 endogenous variables), we adopt a simplifying assumption relative to the original version by imposing the law of one price for exported goods, whereby firms do not differentiate prices across export destinations. Nonetheless, pricing in the export sector remains distinct from that in the non-tradable and home-tradable sectors. This subsection focuses on the model components critical to our extension and policy application, particularly the bundling of final goods, trade specification, and policy rules. For all remaining model features, we refer the reader to \citet{Gomesaetal2012} for the general structure and to \citet{Clancyetal2016} for the enhanced fiscal policy specification.
