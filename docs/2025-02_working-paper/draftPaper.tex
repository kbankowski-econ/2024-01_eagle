...
The model is calibrated to reflect our enhanced geographical structure, most notably the detailed decomposition of the euro area. Specifically, we distinguish ten individual euro area member states—Austria, Belgium, Finland, France, Germany, Greece, Italy, the Netherlands, Portugal, and Spain—alongside a residual region representing the remaining countries. Going beyond the EMU, the calibration also includes the non-euro area European Union, the United States and the rest of the world, resulting in a total of 14 country or regional blocks. Calibration proceeds in line with the established practices, with a focus on matching a set of key ratios to output—often referred to as the “Great Ratios.” These targets are derived from macroeconomic data corresponding to model variables.
...
% Key steady ratios
We calibrate the model for 14 separate regions: Austria, Belgium, Finland, France, Germany, Greece, Italy, the Netherlands, Portugal, Spain, rest of Euro area, non-Euro area EU, the US, and rest of world. We adhere to the established calibration methodology prevalent in academic literature, aiming to align the primary steady-state ratios of different expenditure components with GDP, commonly known as the Great Ratios. These ratios were calculated in alignment with other calibrated data and is reported in Table \ref{tab:national_accounts}. 

%Household, firms and government behaviour
Some parameters of the model regarding household, firm, and government behaviour are kept consistent with the original model (see \citet{Gomesaetal2012}), which employs standard values prevelant in the literature. Table on household, and firms' bias between capital, labour, different types of households, and intermediate goodsa are reported in Table \ref{tab:selectedHhFirmGov} in the calibration section of the technical appendix. Government parameters, such as tax rates, are calibrated using OECD datasets (\citet{OECD_data}). The tax rates in the model include labour, capital, consumption tax, and social security contributions both by the employers, and the employees, and are reported together with other monetary and fiscal authority parameters in Table \ref{tab:policy} below. 
...
One major difference across the economies in our model lies in the composition of domestic demand, particularly the share of government consumption. Several countries, such as Belgium, France, Finland, and the Netherlands, exhibit relatively high government spending ratios, while others, such as the US or Rest of World, show comparatively smaller shares. Significant heterogeneity also arises in the share of imports in final demand components as seen in table 6. Smaller economies, such as countries in the rest of Euro Area, Belgium, and the Netherlands, showcase more openness and import up to over 30\% of their GDP, while others have import share closer to 20\%, with the US and Rest of World having relatively low openness. Net foreign asset position is calibrated endogenously accordingly, with many Euro Area countries having a negative position.  In addition, countries differ in the degree of nominal and real rigidities, with the Rest of World and the US exhibiting lower price and wage stickiness compared to euro area economies. Finally, the relative size of each economy is recalibrated to reflect its share of global GDP, which, in contrast to the original EAGLE setup, provides a more granular transmission channel.
