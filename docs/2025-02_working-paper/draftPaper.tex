...
\makebox[\linewidth]{%
\begin{tabular}{
  >{\raggedright\arraybackslash}p{5cm}  % Item
  >{\raggedright\arraybackslash}p{6.5cm}    % Source
  >{\raggedright\arraybackslash}p{7cm}    % Code
  >{\raggedright\arraybackslash}p{6cm}    % Notes
}
\toprule
...
\multirow{2}{6cm}{IMF ICSD dataset has now been archived. Input-output tables give total investment; split between public and private using IMF ICSD shares of investment as \% of GDP.} \\ [0.2em]
& \makecell[l]{IMF ICSD} && \\ [15pt] 

\textbf{Trade} & & & \\ [0.2em]
Imports & \makecell[l]{OECD ICIO} &  & 
\multirow{2}{6cm}{Leontief framework used to calculate direct and indirect imports (Bussiere et al., 2013). Investment split between public/private using IMF ICSD shares. Same import content assumed due to data gaps.} \\ [0.2em] 
& \makecell[l]{IMF ICSD} &  & \\ [30pt] 
Trade Balance & OECD ICIO & & \\ [0.2em]

\textbf{Government revenue and expenditure} & & &  \\ [0.2em]
Consumption tax rate & \makecell[l]{Revenue: OECD;} & \makecell[l]{CTP.TPS:DSD\_REV\_COMP\_GLOBAL \\(taxes on goods and services)} & 
\multirow{12}{6cm}{Calculated as tax revenue over base. Data for ES and PT capital and labur tax extracted from SDW due to missing OECD data.} \\ [0.5em]
...
& Base: Wage income (OECD) & \makecell[l]{SDD.NAD:DSD\_NAMAIN10} & \\ [0.5em]
Capital tax rate & \makecell[l]{Revenue: OECD, SDW (for ES \& PT)} & \makecell[l]{CTP.TPS:DSD\_REV\_COMP\_GLOBAL; \\ GFS.Q.N.XX.W0.S13.S1.N.C.D91.\_Z.\_Z.\_Z.\\XDC.\_Z.S.V.N.\_T} & \\[35pt]
