...
\begin{equation} \label{eqResourceConstraint}
    \begin{aligned}
        P_{Y,t} Y_t =\ & P_{C,t} \left(C_t + \Gamma_{v,t}\right) + P_{I,t} \left(I_t + \Gamma_u(u_t) K_t\right) + P_{G_C,t} G_{C,t} + P_{G_I,t} G_{I,t} \\
...
\begin{figure}[H]
    ...
    \begin{tikzpicture}[
      ...
      \node[below right=of tb] (y) {production\\ $\left(y_t\right)$};
      \node[right=of demand, yshift=+2cm] (im1) {$IM_t^i$};
      \node[right=of demand, yshift=+1cm] (im2) {$IM_t^i$};
      \node[right=of demand, yshift=-1cm] (im3) {$IM_t^i$};
      \node[right=of demand, yshift=-2cm] (im4) {$IM_t^i$};
