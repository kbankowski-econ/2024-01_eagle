...
classDef exportable fill:#ffd6cc,stroke:none,color:black,font-size:24px;  %% A soft coral orange
 tby["tby: 0.0040"]
 demand["demand = (ntc+nti+g)+(htc+hti)+(imc+imi): 0.9959"]
 qc["qc: 0.6273"]
 ...
 ttc[ttc: 0.2077]
 tti[tti: 0.1531]
 nt[nt: 0.6352]:::nontradable
 ntc[ntc: 0.4197]:::nontradable
 nti[nti: 0.0555]:::nontradable
 ht[ht: 0.2619]:::hometradable
 htc[htc: 0.1508]:::hometradable
 hti[hti: 0.1111]:::hometradable
 sh\*ht[sh\*ht: 0.2619]:::hometradable
 im[im: 0.0990]:::imported
 imc[imc: 0.0570]:::imported
 imi[imi: 0.0420]:::imported
 ysn["ysn=snt\*nt: 0.6352"]:::nontradable
 sx\*ex["sx\*ex: 0.1030"]:::exportable
