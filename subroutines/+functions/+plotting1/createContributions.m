...
contributionSeries = Series(functions.plotting1.Dates_Dseries2Series(rhsval.dates), cc_selection, vnames);
lineSeries = Series(functions.plotting1.Dates_Dseries2Series(rhsval.dates), contribution(:,1), lhs);
