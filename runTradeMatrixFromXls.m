...
for aItem = ["imcy", "imiy", "imcgy", "imigy"]
    ...
    newTable.(aItem) = readtable(xlsFilePath, 'Sheet', 'ssRWadjust', 'ReadRowNames', true, 'Range', rangeStruct.(aItem));
end

%% writing mod trade calibration file
writeTradeModFile('tradeMatrixRWadjust.mod', newTable, sizeStruct, countries, countriesAux, shiftAmount)
