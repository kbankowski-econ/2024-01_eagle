...
@#for COUNTRY in countries
  ...
  @{COUNTRY}_ccesi = 0.426239346856029;       
  @{COUNTRY}_ccesj = 0.00763191640347169;       
  @{COUNTRY}_cg   = 0.02;
  @{COUNTRY}_cgy = 0.001;
  ...
  @{COUNTRY}_mcx = 0.0909090909090905;  
  ...
  @{COUNTRY}_pim = 1;
  @{COUNTRY}_pimc = 1;
  @{COUNTRY}_pimcg = 1.011;
  @{COUNTRY}_pimi = 1;
  @{COUNTRY}_pimig = 1.011;
  @{COUNTRY}_pimx = 1;
  @{COUNTRY}_pint = 1;
  @{COUNTRY}_piw = 1;
  @{COUNTRY}_piw4  = 1;
  ...
  @{COUNTRY}_pttcg = 1.011;
  @{COUNTRY}_ptti = 0.999999999999924;
  @{COUNTRY}_pttig = 1.011;
  ...
  @#for COUNTRY1 IN countries
    @#if (COUNTRY != COUNTRY1)
      ...
      @{COUNTRY}@{COUNTRY1}_imcg = eps*1000;
      @{COUNTRY}@{COUNTRY1}_imcgy = eps*1000;
      @{COUNTRY}@{COUNTRY1}_imi = 0.0003;
      @{COUNTRY}@{COUNTRY1}_imig = 0.000000592952;
      @{COUNTRY}@{COUNTRY1}_imigy = 0.0000020997;
      @{COUNTRY}@{COUNTRY1}_imx = 0.0000025;
      ...
      @{COUNTRY}@{COUNTRY1}_gammaimx = 0;
      @{COUNTRY}@{COUNTRY1}_gammaimxdag = 1;
