...
@#include "params_eq_SI.mod"

@#include "initval_eq_SI.mod"
options_.maxit_ = 80;
...
steady(homotopy_mode = 1, homotopy_steps = 30, solve_algo = 6, markowitz = 5);
...
//Share of nontradable intermediate consumption good in final consumption good:
disp('nuc')
homotopy_setup;
EAA_nuc, 0.35;
RW_nuc,  0.35;
...
//Share of nontradable intermediate investment good in final investment good:
disp('nui')
homotopy_setup;
EAA_nui, 0.75;
RW_nui,  0.75;
...
//1-Share of imported tradable intermediate consumption good in intermediate tradable consumption good:
disp('nutc')
homotopy_setup;
EAA_nutc, 0.20;
RW_nutc,  0.20;
...
//1-Share of imported tradable intermediate investment good in intermediate tradable investment good:
disp('nuti')
homotopy_setup;
EAA_nuti, 0.20;
RW_nuti,  0.20;
...
steady(homotopy_mode = 1, homotopy_steps = 15, solve_algo = 5, markowitz = 5);
...
save_params_and_steady_state('eagle_steady_stage1_eq_SI.txt');
