...
classDef exportable fill:#ffd6cc,stroke:none,color:black,font-size:24px;  %% A soft coral orange
 tby["tby: 0.0038"]
 demand["demand = (ntc+nti+ntcg+ntig)+(htc+hti+htcg+htig)+(imc+imi+imcg+imig): 0.9962"]
 qc["qc: 0.5962"]
 qcg["qcg: 0.1600"]
 qi["qi: 0.2000"]
 qig["qig: 0.0400"]
 ...
 tti[tti: 0.1473]
 ttig[ttig: 0.0317]
 nt[nt: 0.4925]:::nontradable
 ntc[ntc: 0.3985]:::nontradable
 nti[nti: 0.0527]:::nontradable
 ntcg[ntcg: 0.0330]:::nontradable
 ntig[ntig: 0.0083]:::nontradable
 ht[ht: 0.3891]:::hometradable
 htc[htc: 0.1324]:::hometradable
 htcg[htcg: 0.1197]:::hometradable
 hti[hti: 0.1095]:::hometradable
 htig[htig: 0.0275]:::hometradable
 sh\*ht[sh\*ht: 0.3891]:::hometradable
 im[im: 0.1146]:::imported
 imc[imc: 0.0653]:::imported
 imcg[imcg: 0.0073]:::imported
 imi[imi: 0.0378]:::imported
 imig[imig: 0.0042]:::imported
 imig[imig: 0.0042]:::imported
 ysn["ysn=snt\*nt: 0.4925"]:::nontradable
 sx\*ex["sx\*ex: 0.1184"]:::exportable
