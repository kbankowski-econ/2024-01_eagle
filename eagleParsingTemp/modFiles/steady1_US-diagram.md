...
classDef exportable fill:#ffd6cc,stroke:none,color:black,font-size:24px;  %% A soft coral orange
 tby["tby: -0.0070"]
 demand["demand = (ntc+nti+ntcg+ntig)+(htc+hti+htcg+htig)+(imc+imi+imcg+imig): 1.0070"]
 qc["qc: 0.5933"]
 qcg["qcg: 0.1600"]
 qi["qi: 0.2137"]
 qig["qig: 0.0400"]
 ...
 tti[tti: 0.1580]
 ttig[ttig: 0.0313]
 nt[nt: 0.4928]:::nontradable
 ntc[ntc: 0.3933]:::nontradable
 nti[nti: 0.0558]:::nontradable
 ntcg[ntcg: 0.0349]:::nontradable
 ntig[ntig: 0.0087]:::nontradable
 ht[ht: 0.3429]:::hometradable
 htc[htc: 0.1572]:::hometradable
 htcg[htcg: 0.0492]:::hometradable
 hti[hti: 0.1242]:::hometradable
 htig[htig: 0.0123]:::hometradable
 sh\*ht[sh\*ht: 0.3429]:::hometradable
 im[im: 0.1713]:::imported
 imc[imc: 0.0428]:::imported
 imcg[imcg: 0.0758]:::imported
 imi[imi: 0.0338]:::imported
 imig[imig: 0.0190]:::imported
 imig[imig: 0.0190]:::imported
 ysn["ysn=snt\*nt: 0.4928"]:::nontradable
 sx\*ex["sx\*ex: 0.1643"]:::exportable
