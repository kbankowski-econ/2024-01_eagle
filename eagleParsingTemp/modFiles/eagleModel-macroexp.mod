...
EAAEAE_imc = EAAEAE_numc*(EAAEAE_pim/(EAAEAE_gammaimcdag*EAA_pimc))^(-EAA_mumc)*EAA_imc/(1-EAAEAE_gammaimc);
EAAEAC_imc = EAAEAC_numc*(EAAEAC_pim/(EAAEAC_gammaimcdag*EAA_pimc))^(-EAA_mumc)*EAA_imc/(1-EAAEAC_gammaimc);
EAAEAD_imc = EAAEAD_numc*(EAAEAD_pim/(EAAEAD_gammaimcdag*EAA_pimc))^(-EAA_mumc)*EAA_imc/(1-EAAEAD_gammaimc);
...
+EAAEAD_numc *(EAAEAD_pim/EAAEAD_gammaimcdag)^(1-EAA_mumc)
+EAAEAE_numc *(EAAEAE_pim/EAAEAE_gammaimcdag)^(1-EAA_mumc)
...
// Demand for bilateral consumption import goods
EAAEAE_imi = EAAEAE_numi*(EAAEAE_pim/(EAAEAE_gammaimidag*EAA_pimi))^(-EAA_mumi)*EAA_imi/(1-EAAEAE_gammaimi);
EAAEAC_imi = EAAEAC_numi*(EAAEAC_pim/(EAAEAC_gammaimidag*EAA_pimi))^(-EAA_mumi)*EAA_imi/(1-EAAEAC_gammaimi);
EAAEAD_imi = EAAEAD_numi*(EAAEAD_pim/(EAAEAD_gammaimidag*EAA_pimi))^(-EAA_mumi)*EAA_imi/(1-EAAEAD_gammaimi);
...
+EAAEAD_numi *(EAAEAD_pim/EAAEAD_gammaimidag)^(1-EAA_mumi)
+EAAEAE_numi *(EAAEAE_pim/EAAEAE_gammaimidag)^(1-EAA_mumi)
...
// Demand for bilateral consumption import goods
EAAEAE_imcg = EAAEAE_numcg*(EAAEAE_pim/(EAAEAE_gammaimcgdag*EAA_pimcg))^(-EAA_mumcg)*EAA_imcg/(1-EAAEAE_gammaimcg);
EAAEAC_imcg = EAAEAC_numcg*(EAAEAC_pim/(EAAEAC_gammaimcgdag*EAA_pimcg))^(-EAA_mumcg)*EAA_imcg/(1-EAAEAC_gammaimcg);
EAAEAD_imcg = EAAEAD_numcg*(EAAEAD_pim/(EAAEAD_gammaimcgdag*EAA_pimcg))^(-EAA_mumcg)*EAA_imcg/(1-EAAEAD_gammaimcg);
EAAUS_imcg = EAAUS_numcg*(EAAUS_pim/(EAAUS_gammaimcgdag*EAA_pimcg))^(-EAA_mumcg)*EAA_imcg/(1-EAAUS_gammaimcg);
EAARW_imcg = (1
-EAAEAB_numcg
-EAAEAC_numcg
-EAAEAD_numcg
-EAAEAE_numcg
-EAAUS_numcg
)*(EAARW_pim/(EAARW_gammaimcgdag*EAA_pimcg))^(-EAA_mumcg)*EAA_imcg/(1-EAARW_gammaimcg);
// Price of the consumption good (import)
EAA_pimcg^(1-EAA_mumcg) =
+EAAEAB_numcg *(EAAEAB_pim/EAAEAB_gammaimcgdag)^(1-EAA_mumcg)
+EAAEAC_numcg *(EAAEAC_pim/EAAEAC_gammaimcgdag)^(1-EAA_mumcg)
+EAAEAD_numcg *(EAAEAD_pim/EAAEAD_gammaimcgdag)^(1-EAA_mumcg)
+EAAEAE_numcg *(EAAEAE_pim/EAAEAE_gammaimcgdag)^(1-EAA_mumcg)
+EAAUS_numcg *(EAAUS_pim/EAAUS_gammaimcgdag)^(1-EAA_mumcg)
+(1
-EAAEAB_numcg
-EAAEAC_numcg
-EAAEAD_numcg
-EAAEAE_numcg
-EAAUS_numcg
)*(EAARW_pim/EAARW_gammaimcgdag)^(1-EAA_mumcg);
// Private consumption good (import) inflation
...
// Demand for bilateral consumption import goods
EAAEAE_imig = EAAEAE_numig*(EAAEAE_pim/(EAAEAE_gammaimigdag*EAA_pimig))^(-EAA_mumig)*EAA_imig/(1-EAAEAE_gammaimig);
EAAEAC_imig = EAAEAC_numig*(EAAEAC_pim/(EAAEAC_gammaimigdag*EAA_pimig))^(-EAA_mumig)*EAA_imig/(1-EAAEAC_gammaimig);
EAAEAD_imig = EAAEAD_numig*(EAAEAD_pim/(EAAEAD_gammaimigdag*EAA_pimig))^(-EAA_mumig)*EAA_imig/(1-EAAEAD_gammaimig);
EAAUS_imig = EAAUS_numig*(EAAUS_pim/(EAAUS_gammaimigdag*EAA_pimig))^(-EAA_mumig)*EAA_imig/(1-EAAUS_gammaimig);
EAARW_imig = (1
-EAAEAB_numig
-EAAEAC_numig
-EAAEAD_numig
-EAAEAE_numig
-EAAUS_numig
)*(EAARW_pim/(EAARW_gammaimigdag*EAA_pimig))^(-EAA_mumig)*EAA_imig/(1-EAARW_gammaimig);
// Price of the consumption good (import)
EAA_pimig^(1-EAA_mumig) =
+EAAEAB_numig *(EAAEAB_pim/EAAEAB_gammaimigdag)^(1-EAA_mumig)
+EAAEAC_numig *(EAAEAC_pim/EAAEAC_gammaimigdag)^(1-EAA_mumig)
+EAAEAD_numig *(EAAEAD_pim/EAAEAD_gammaimigdag)^(1-EAA_mumig)
+EAAEAE_numig *(EAAEAE_pim/EAAEAE_gammaimigdag)^(1-EAA_mumig)
+EAAUS_numig *(EAAUS_pim/EAAUS_gammaimigdag)^(1-EAA_mumig)
+(1
-EAAEAB_numig
-EAAEAC_numig
-EAAEAD_numig
-EAAEAE_numig
-EAAUS_numig
)*(EAARW_pim/EAARW_gammaimigdag)^(1-EAA_mumig);
// Private consumption good (import) inflation
...
+EAAEAD_rer*EADEAA_pim*EAD_size/EAA_size*EADEAA_im
-EAAEAD_pim*(EAAEAD_imc*(1-EAAEAD_gammaimc)/EAAEAD_gammaimcdag)
-EAAEAD_pim*(EAAEAD_imi*(1-EAAEAD_gammaimi)/EAAEAD_gammaimidag)
-EAAEAD_pim*EAAEAD_imcg
-EAAEAD_pim*EAAEAD_imig
+EAAEAE_rer*EAEEAA_pim*EAE_size/EAA_size*EAEEAA_im
-EAAEAE_pim*(EAAEAE_imc*(1-EAAEAE_gammaimc)/EAAEAE_gammaimcdag)
-EAAEAE_pim*(EAAEAE_imi*(1-EAAEAE_gammaimi)/EAAEAE_gammaimidag)
...
EABEAD_imc = EABEAD_numc*(EABEAD_pim/(EABEAD_gammaimcdag*EAB_pimc))^(-EAB_mumc)*EAB_imc/(1-EABEAD_gammaimc);
EABEAE_imc = EABEAE_numc*(EABEAE_pim/(EABEAE_gammaimcdag*EAB_pimc))^(-EAB_mumc)*EAB_imc/(1-EABEAE_gammaimc);
...
+EABEAD_numc *(EABEAD_pim/EABEAD_gammaimcdag)^(1-EAB_mumc)
+EABEAE_numc *(EABEAE_pim/EABEAE_gammaimcdag)^(1-EAB_mumc)
...
EABEAD_imi = EABEAD_numi*(EABEAD_pim/(EABEAD_gammaimidag*EAB_pimi))^(-EAB_mumi)*EAB_imi/(1-EABEAD_gammaimi);
EABEAE_imi = EABEAE_numi*(EABEAE_pim/(EABEAE_gammaimidag*EAB_pimi))^(-EAB_mumi)*EAB_imi/(1-EABEAE_gammaimi);
...
+EABEAD_numi *(EABEAD_pim/EABEAD_gammaimidag)^(1-EAB_mumi)
+EABEAE_numi *(EABEAE_pim/EABEAE_gammaimidag)^(1-EAB_mumi)
...
// Demand for bilateral consumption import goods
EABRW_imcg = EABRW_numcg*(EABRW_pim/(EABRW_gammaimcgdag*EAB_pimcg))^(-EAB_mumcg)*EAB_imcg/(1-EABRW_gammaimcg);
EABEAD_imcg = EABEAD_numcg*(EABEAD_pim/(EABEAD_gammaimcgdag*EAB_pimcg))^(-EAB_mumcg)*EAB_imcg/(1-EABEAD_gammaimcg);
EABEAE_imcg = EABEAE_numcg*(EABEAE_pim/(EABEAE_gammaimcgdag*EAB_pimcg))^(-EAB_mumcg)*EAB_imcg/(1-EABEAE_gammaimcg);
EABEAA_imcg = EABEAA_numcg*(EABEAA_pim/(EABEAA_gammaimcgdag*EAB_pimcg))^(-EAB_mumcg)*EAB_imcg/(1-EABEAA_gammaimcg);
EABUS_imcg = (1
-EABEAA_numcg
-EABEAC_numcg
-EABEAD_numcg
-EABEAE_numcg
-EABRW_numcg
)*(EABUS_pim/(EABUS_gammaimcgdag*EAB_pimcg))^(-EAB_mumcg)*EAB_imcg/(1-EABUS_gammaimcg);
// Price of the consumption good (import)
EAB_pimcg^(1-EAB_mumcg) =
+EABEAA_numcg *(EABEAA_pim/EABEAA_gammaimcgdag)^(1-EAB_mumcg)
+EABEAC_numcg *(EABEAC_pim/EABEAC_gammaimcgdag)^(1-EAB_mumcg)
+EABEAD_numcg *(EABEAD_pim/EABEAD_gammaimcgdag)^(1-EAB_mumcg)
+EABEAE_numcg *(EABEAE_pim/EABEAE_gammaimcgdag)^(1-EAB_mumcg)
+EABRW_numcg *(EABRW_pim/EABRW_gammaimcgdag)^(1-EAB_mumcg)
+(1
-EABEAA_numcg
-EABEAC_numcg
-EABEAD_numcg
-EABEAE_numcg
-EABRW_numcg
)*(EABUS_pim/EABUS_gammaimcgdag)^(1-EAB_mumcg);
// Private consumption good (import) inflation
...
// Demand for bilateral consumption import goods
EABRW_imig = EABRW_numig*(EABRW_pim/(EABRW_gammaimigdag*EAB_pimig))^(-EAB_mumig)*EAB_imig/(1-EABRW_gammaimig);
EABEAD_imig = EABEAD_numig*(EABEAD_pim/(EABEAD_gammaimigdag*EAB_pimig))^(-EAB_mumig)*EAB_imig/(1-EABEAD_gammaimig);
EABEAE_imig = EABEAE_numig*(EABEAE_pim/(EABEAE_gammaimigdag*EAB_pimig))^(-EAB_mumig)*EAB_imig/(1-EABEAE_gammaimig);
EABEAA_imig = EABEAA_numig*(EABEAA_pim/(EABEAA_gammaimigdag*EAB_pimig))^(-EAB_mumig)*EAB_imig/(1-EABEAA_gammaimig);
EABUS_imig = (1
-EABEAA_numig
-EABEAC_numig
-EABEAD_numig
-EABEAE_numig
-EABRW_numig
)*(EABUS_pim/(EABUS_gammaimigdag*EAB_pimig))^(-EAB_mumig)*EAB_imig/(1-EABUS_gammaimig);
// Price of the consumption good (import)
EAB_pimig^(1-EAB_mumig) =
+EABEAA_numig *(EABEAA_pim/EABEAA_gammaimigdag)^(1-EAB_mumig)
+EABEAC_numig *(EABEAC_pim/EABEAC_gammaimigdag)^(1-EAB_mumig)
+EABEAD_numig *(EABEAD_pim/EABEAD_gammaimigdag)^(1-EAB_mumig)
+EABEAE_numig *(EABEAE_pim/EABEAE_gammaimigdag)^(1-EAB_mumig)
+EABRW_numig *(EABRW_pim/EABRW_gammaimigdag)^(1-EAB_mumig)
+(1
-EABEAA_numig
-EABEAC_numig
-EABEAD_numig
-EABEAE_numig
-EABRW_numig
)*(EABUS_pim/EABUS_gammaimigdag)^(1-EAB_mumig);
// Private consumption good (import) inflation
...
+EABEAD_rer*EADEAB_pim*EAD_size/EAB_size*EADEAB_im
-EABEAD_pim*(EABEAD_imc*(1-EABEAD_gammaimc)/EABEAD_gammaimcdag)
-EABEAD_pim*(EABEAD_imi*(1-EABEAD_gammaimi)/EABEAD_gammaimidag)
-EABEAD_pim*EABEAD_imcg
-EABEAD_pim*EABEAD_imig
+EABEAE_rer*EAEEAB_pim*EAE_size/EAB_size*EAEEAB_im
-EABEAE_pim*(EABEAE_imc*(1-EABEAE_gammaimc)/EABEAE_gammaimcdag)
-EABEAE_pim*(EABEAE_imi*(1-EABEAE_gammaimi)/EABEAE_gammaimidag)
...
EACEAE_imc = EACEAE_numc*(EACEAE_pim/(EACEAE_gammaimcdag*EAC_pimc))^(-EAC_mumc)*EAC_imc/(1-EACEAE_gammaimc);
EACRW_imc = EACRW_numc*(EACRW_pim/(EACRW_gammaimcdag*EAC_pimc))^(-EAC_mumc)*EAC_imc/(1-EACRW_gammaimc);
...
+EACEAD_numc *(EACEAD_pim/EACEAD_gammaimcdag)^(1-EAC_mumc)
+EACEAE_numc *(EACEAE_pim/EACEAE_gammaimcdag)^(1-EAC_mumc)
...
-EACRW_numc
-EACUS_numc
)*(EACEAA_pim/EACEAA_gammaimcdag)^(1-EAC_mumc);
// Private consumption good (import) inflation
...
EACEAE_imi = EACEAE_numi*(EACEAE_pim/(EACEAE_gammaimidag*EAC_pimi))^(-EAC_mumi)*EAC_imi/(1-EACEAE_gammaimi);
EACRW_imi = EACRW_numi*(EACRW_pim/(EACRW_gammaimidag*EAC_pimi))^(-EAC_mumi)*EAC_imi/(1-EACRW_gammaimi);
...
+EACEAD_numi *(EACEAD_pim/EACEAD_gammaimidag)^(1-EAC_mumi)
+EACEAE_numi *(EACEAE_pim/EACEAE_gammaimidag)^(1-EAC_mumi)
...
-EACRW_numi
-EACUS_numi
)*(EACEAA_pim/EACEAA_gammaimidag)^(1-EAC_mumi);
// Private consumption good (import) inflation
...
// Demand for bilateral consumption import goods
EACUS_imcg = EACUS_numcg*(EACUS_pim/(EACUS_gammaimcgdag*EAC_pimcg))^(-EAC_mumcg)*EAC_imcg/(1-EACUS_gammaimcg);
EACEAE_imcg = EACEAE_numcg*(EACEAE_pim/(EACEAE_gammaimcgdag*EAC_pimcg))^(-EAC_mumcg)*EAC_imcg/(1-EACEAE_gammaimcg);
EACRW_imcg = EACRW_numcg*(EACRW_pim/(EACRW_gammaimcgdag*EAC_pimcg))^(-EAC_mumcg)*EAC_imcg/(1-EACRW_gammaimcg);
EACEAB_imcg = EACEAB_numcg*(EACEAB_pim/(EACEAB_gammaimcgdag*EAC_pimcg))^(-EAC_mumcg)*EAC_imcg/(1-EACEAB_gammaimcg);
EACEAA_imcg = (1
-EACEAB_numcg
-EACEAD_numcg
-EACEAE_numcg
-EACRW_numcg
-EACUS_numcg
)*(EACEAA_pim/(EACEAA_gammaimcgdag*EAC_pimcg))^(-EAC_mumcg)*EAC_imcg/(1-EACEAA_gammaimcg);
// Price of the consumption good (import)
EAC_pimcg^(1-EAC_mumcg) =
+EACEAB_numcg *(EACEAB_pim/EACEAB_gammaimcgdag)^(1-EAC_mumcg)
+EACEAD_numcg *(EACEAD_pim/EACEAD_gammaimcgdag)^(1-EAC_mumcg)
+EACEAE_numcg *(EACEAE_pim/EACEAE_gammaimcgdag)^(1-EAC_mumcg)
+EACRW_numcg *(EACRW_pim/EACRW_gammaimcgdag)^(1-EAC_mumcg)
+EACUS_numcg *(EACUS_pim/EACUS_gammaimcgdag)^(1-EAC_mumcg)
+(1
-EACEAB_numcg
-EACEAD_numcg
-EACEAE_numcg
-EACRW_numcg
-EACUS_numcg
)*(EACEAA_pim/EACEAA_gammaimcgdag)^(1-EAC_mumcg);
// Private consumption good (import) inflation
...
// Demand for bilateral consumption import goods
EACUS_imig = EACUS_numig*(EACUS_pim/(EACUS_gammaimigdag*EAC_pimig))^(-EAC_mumig)*EAC_imig/(1-EACUS_gammaimig);
EACEAE_imig = EACEAE_numig*(EACEAE_pim/(EACEAE_gammaimigdag*EAC_pimig))^(-EAC_mumig)*EAC_imig/(1-EACEAE_gammaimig);
EACRW_imig = EACRW_numig*(EACRW_pim/(EACRW_gammaimigdag*EAC_pimig))^(-EAC_mumig)*EAC_imig/(1-EACRW_gammaimig);
EACEAB_imig = EACEAB_numig*(EACEAB_pim/(EACEAB_gammaimigdag*EAC_pimig))^(-EAC_mumig)*EAC_imig/(1-EACEAB_gammaimig);
EACEAA_imig = (1
-EACEAB_numig
-EACEAD_numig
-EACEAE_numig
-EACRW_numig
-EACUS_numig
)*(EACEAA_pim/(EACEAA_gammaimigdag*EAC_pimig))^(-EAC_mumig)*EAC_imig/(1-EACEAA_gammaimig);
// Price of the consumption good (import)
EAC_pimig^(1-EAC_mumig) =
+EACEAB_numig *(EACEAB_pim/EACEAB_gammaimigdag)^(1-EAC_mumig)
+EACEAD_numig *(EACEAD_pim/EACEAD_gammaimigdag)^(1-EAC_mumig)
+EACEAE_numig *(EACEAE_pim/EACEAE_gammaimigdag)^(1-EAC_mumig)
+EACRW_numig *(EACRW_pim/EACRW_gammaimigdag)^(1-EAC_mumig)
+EACUS_numig *(EACUS_pim/EACUS_gammaimigdag)^(1-EAC_mumig)
+(1
-EACEAB_numig
-EACEAD_numig
-EACEAE_numig
-EACRW_numig
-EACUS_numig
)*(EACEAA_pim/EACEAA_gammaimigdag)^(1-EAC_mumig);
// Private consumption good (import) inflation
...
+EACEAD_rer*EADEAC_pim*EAD_size/EAC_size*EADEAC_im
-EACEAD_pim*(EACEAD_imc*(1-EACEAD_gammaimc)/EACEAD_gammaimcdag)
-EACEAD_pim*(EACEAD_imi*(1-EACEAD_gammaimi)/EACEAD_gammaimidag)
-EACEAD_pim*EACEAD_imcg
-EACEAD_pim*EACEAD_imig
+EACEAE_rer*EAEEAC_pim*EAE_size/EAC_size*EAEEAC_im
-EACEAE_pim*(EACEAE_imc*(1-EACEAE_gammaimc)/EACEAE_gammaimcdag)
-EACEAE_pim*(EACEAE_imi*(1-EACEAE_gammaimi)/EACEAE_gammaimidag)
...
// Demand for bilateral consumption import goods
EADEAA_imc = EADEAA_numc*(EADEAA_pim/(EADEAA_gammaimcdag*EAD_pimc))^(-EAD_mumc)*EAD_imc/(1-EADEAA_gammaimc);
EADRW_imc = EADRW_numc*(EADRW_pim/(EADRW_gammaimcdag*EAD_pimc))^(-EAD_mumc)*EAD_imc/(1-EADRW_gammaimc);
EADUS_imc = EADUS_numc*(EADUS_pim/(EADUS_gammaimcdag*EAD_pimc))^(-EAD_mumc)*EAD_imc/(1-EADUS_gammaimc);
EADEAC_imc = EADEAC_numc*(EADEAC_pim/(EADEAC_gammaimcdag*EAD_pimc))^(-EAD_mumc)*EAD_imc/(1-EADEAC_gammaimc);
EADEAB_imc = (1
-EADEAA_numc
-EADEAC_numc
-EADEAE_numc
-EADRW_numc
-EADUS_numc
)*(EADEAB_pim/(EADEAB_gammaimcdag*EAD_pimc))^(-EAD_mumc)*EAD_imc/(1-EADEAB_gammaimc);
// Price of the consumption good (import)
EAD_pimc^(1-EAD_mumc) =
+EADEAA_numc *(EADEAA_pim/EADEAA_gammaimcdag)^(1-EAD_mumc)
+EADEAC_numc *(EADEAC_pim/EADEAC_gammaimcdag)^(1-EAD_mumc)
+EADEAE_numc *(EADEAE_pim/EADEAE_gammaimcdag)^(1-EAD_mumc)
+EADRW_numc *(EADRW_pim/EADRW_gammaimcdag)^(1-EAD_mumc)
+EADUS_numc *(EADUS_pim/EADUS_gammaimcdag)^(1-EAD_mumc)
+(1
-EADEAA_numc
-EADEAC_numc
-EADEAE_numc
-EADRW_numc
-EADUS_numc
)*(EADEAB_pim/EADEAB_gammaimcdag)^(1-EAD_mumc);
// Private consumption good (import) inflation
...
// Demand for bilateral consumption import goods
EADEAA_imi = EADEAA_numi*(EADEAA_pim/(EADEAA_gammaimidag*EAD_pimi))^(-EAD_mumi)*EAD_imi/(1-EADEAA_gammaimi);
EADRW_imi = EADRW_numi*(EADRW_pim/(EADRW_gammaimidag*EAD_pimi))^(-EAD_mumi)*EAD_imi/(1-EADRW_gammaimi);
EADUS_imi = EADUS_numi*(EADUS_pim/(EADUS_gammaimidag*EAD_pimi))^(-EAD_mumi)*EAD_imi/(1-EADUS_gammaimi);
EADEAC_imi = EADEAC_numi*(EADEAC_pim/(EADEAC_gammaimidag*EAD_pimi))^(-EAD_mumi)*EAD_imi/(1-EADEAC_gammaimi);
EADEAB_imi = (1
-EADEAA_numi
-EADEAC_numi
-EADEAE_numi
-EADRW_numi
-EADUS_numi
)*(EADEAB_pim/(EADEAB_gammaimidag*EAD_pimi))^(-EAD_mumi)*EAD_imi/(1-EADEAB_gammaimi);
// Price of the consumption good (import)
EAD_pimi^(1-EAD_mumi) =
+EADEAA_numi *(EADEAA_pim/EADEAA_gammaimidag)^(1-EAD_mumi)
+EADEAC_numi *(EADEAC_pim/EADEAC_gammaimidag)^(1-EAD_mumi)
+EADEAE_numi *(EADEAE_pim/EADEAE_gammaimidag)^(1-EAD_mumi)
+EADRW_numi *(EADRW_pim/EADRW_gammaimidag)^(1-EAD_mumi)
+EADUS_numi *(EADUS_pim/EADUS_gammaimidag)^(1-EAD_mumi)
+(1
-EADEAA_numi
-EADEAC_numi
-EADEAE_numi
-EADRW_numi
-EADUS_numi
)*(EADEAB_pim/EADEAB_gammaimidag)^(1-EAD_mumi);
// Private consumption good (import) inflation
...
// Demand for bilateral consumption import goods
EADEAA_imcg = EADEAA_numcg*(EADEAA_pim/(EADEAA_gammaimcgdag*EAD_pimcg))^(-EAD_mumcg)*EAD_imcg/(1-EADEAA_gammaimcg);
EADRW_imcg = EADRW_numcg*(EADRW_pim/(EADRW_gammaimcgdag*EAD_pimcg))^(-EAD_mumcg)*EAD_imcg/(1-EADRW_gammaimcg);
EADUS_imcg = EADUS_numcg*(EADUS_pim/(EADUS_gammaimcgdag*EAD_pimcg))^(-EAD_mumcg)*EAD_imcg/(1-EADUS_gammaimcg);
EADEAC_imcg = EADEAC_numcg*(EADEAC_pim/(EADEAC_gammaimcgdag*EAD_pimcg))^(-EAD_mumcg)*EAD_imcg/(1-EADEAC_gammaimcg);
EADEAB_imcg = (1
-EADEAA_numcg
-EADEAC_numcg
-EADEAE_numcg
-EADRW_numcg
-EADUS_numcg
)*(EADEAB_pim/(EADEAB_gammaimcgdag*EAD_pimcg))^(-EAD_mumcg)*EAD_imcg/(1-EADEAB_gammaimcg);
// Price of the consumption good (import)
EAD_pimcg^(1-EAD_mumcg) =
+EADEAA_numcg *(EADEAA_pim/EADEAA_gammaimcgdag)^(1-EAD_mumcg)
+EADEAC_numcg *(EADEAC_pim/EADEAC_gammaimcgdag)^(1-EAD_mumcg)
+EADEAE_numcg *(EADEAE_pim/EADEAE_gammaimcgdag)^(1-EAD_mumcg)
+EADRW_numcg *(EADRW_pim/EADRW_gammaimcgdag)^(1-EAD_mumcg)
+EADUS_numcg *(EADUS_pim/EADUS_gammaimcgdag)^(1-EAD_mumcg)
+(1
-EADEAA_numcg
-EADEAC_numcg
-EADEAE_numcg
-EADRW_numcg
-EADUS_numcg
)*(EADEAB_pim/EADEAB_gammaimcgdag)^(1-EAD_mumcg);
// Private consumption good (import) inflation
...
// Demand for bilateral consumption import goods
EADEAA_imig = EADEAA_numig*(EADEAA_pim/(EADEAA_gammaimigdag*EAD_pimig))^(-EAD_mumig)*EAD_imig/(1-EADEAA_gammaimig);
EADRW_imig = EADRW_numig*(EADRW_pim/(EADRW_gammaimigdag*EAD_pimig))^(-EAD_mumig)*EAD_imig/(1-EADRW_gammaimig);
EADUS_imig = EADUS_numig*(EADUS_pim/(EADUS_gammaimigdag*EAD_pimig))^(-EAD_mumig)*EAD_imig/(1-EADUS_gammaimig);
EADEAC_imig = EADEAC_numig*(EADEAC_pim/(EADEAC_gammaimigdag*EAD_pimig))^(-EAD_mumig)*EAD_imig/(1-EADEAC_gammaimig);
EADEAB_imig = (1
-EADEAA_numig
-EADEAC_numig
-EADEAE_numig
-EADRW_numig
-EADUS_numig
)*(EADEAB_pim/(EADEAB_gammaimigdag*EAD_pimig))^(-EAD_mumig)*EAD_imig/(1-EADEAB_gammaimig);
// Price of the consumption good (import)
EAD_pimig^(1-EAD_mumig) =
+EADEAA_numig *(EADEAA_pim/EADEAA_gammaimigdag)^(1-EAD_mumig)
+EADEAC_numig *(EADEAC_pim/EADEAC_gammaimigdag)^(1-EAD_mumig)
+EADEAE_numig *(EADEAE_pim/EADEAE_gammaimigdag)^(1-EAD_mumig)
+EADRW_numig *(EADRW_pim/EADRW_gammaimigdag)^(1-EAD_mumig)
+EADUS_numig *(EADUS_pim/EADUS_gammaimigdag)^(1-EAD_mumig)
+(1
-EADEAA_numig
-EADEAC_numig
-EADEAE_numig
-EADRW_numig
-EADUS_numig
)*(EADEAB_pim/EADEAB_gammaimigdag)^(1-EAD_mumig);
// Private consumption good (import) inflation
...
+EAD_pig*EAD_qig
+EADEAA_rer*EAAEAD_pim*EAA_size/EAD_size*EAAEAD_im
-EADEAA_pim*(EADEAA_imc*(1-EADEAA_gammaimc)/EADEAA_gammaimcdag)
-EADEAA_pim*(EADEAA_imi*(1-EADEAA_gammaimi)/EADEAA_gammaimidag)
-EADEAA_pim*EADEAA_imcg
-EADEAA_pim*EADEAA_imig
+EADEAB_rer*EABEAD_pim*EAB_size/EAD_size*EABEAD_im
-EADEAB_pim*(EADEAB_imc*(1-EADEAB_gammaimc)/EADEAB_gammaimcdag)
-EADEAB_pim*(EADEAB_imi*(1-EADEAB_gammaimi)/EADEAB_gammaimidag)
-EADEAB_pim*EADEAB_imcg
-EADEAB_pim*EADEAB_imig
+EADEAC_rer*EACEAD_pim*EAC_size/EAD_size*EACEAD_im
-EADEAC_pim*(EADEAC_imc*(1-EADEAC_gammaimc)/EADEAC_gammaimcdag)
-EADEAC_pim*(EADEAC_imi*(1-EADEAC_gammaimi)/EADEAC_gammaimidag)
-EADEAC_pim*EADEAC_imcg
-EADEAC_pim*EADEAC_imig
+EADEAE_rer*EAEEAD_pim*EAE_size/EAD_size*EAEEAD_im
-EADEAE_pim*(EADEAE_imc*(1-EADEAE_gammaimc)/EADEAE_gammaimcdag)
-EADEAE_pim*(EADEAE_imi*(1-EADEAE_gammaimi)/EADEAE_gammaimidag)
-EADEAE_pim*EADEAE_imcg
-EADEAE_pim*EADEAE_imig
+EADRW_rer*RWEAD_pim*RW_size/EAD_size*RWEAD_im
-EADRW_pim*(EADRW_imc*(1-EADRW_gammaimc)/EADRW_gammaimcdag)
-EADRW_pim*(EADRW_imi*(1-EADRW_gammaimi)/EADRW_gammaimidag)
-EADRW_pim*EADRW_imcg
-EADRW_pim*EADRW_imig
+EADUS_rer*USEAD_pim*US_size/EAD_size*USEAD_im
-EADUS_pim*(EADUS_imc*(1-EADUS_gammaimc)/EADUS_gammaimcdag)
-EADUS_pim*(EADUS_imi*(1-EADUS_gammaimi)/EADUS_gammaimidag)
...
// Demand for bilateral consumption import goods
EAEEAB_imc = EAEEAB_numc*(EAEEAB_pim/(EAEEAB_gammaimcdag*EAE_pimc))^(-EAE_mumc)*EAE_imc/(1-EAEEAB_gammaimc);
EAEUS_imc = EAEUS_numc*(EAEUS_pim/(EAEUS_gammaimcdag*EAE_pimc))^(-EAE_mumc)*EAE_imc/(1-EAEUS_gammaimc);
EAEEAA_imc = EAEEAA_numc*(EAEEAA_pim/(EAEEAA_gammaimcdag*EAE_pimc))^(-EAE_mumc)*EAE_imc/(1-EAEEAA_gammaimc);
EAEEAD_imc = EAEEAD_numc*(EAEEAD_pim/(EAEEAD_gammaimcdag*EAE_pimc))^(-EAE_mumc)*EAE_imc/(1-EAEEAD_gammaimc);
EAEEAC_imc = (1
-EAEEAA_numc
-EAEEAB_numc
-EAEEAD_numc
-EAERW_numc
-EAEUS_numc
)*(EAEEAC_pim/(EAEEAC_gammaimcdag*EAE_pimc))^(-EAE_mumc)*EAE_imc/(1-EAEEAC_gammaimc);
// Price of the consumption good (import)
EAE_pimc^(1-EAE_mumc) =
+EAEEAA_numc *(EAEEAA_pim/EAEEAA_gammaimcdag)^(1-EAE_mumc)
+EAEEAB_numc *(EAEEAB_pim/EAEEAB_gammaimcdag)^(1-EAE_mumc)
+EAEEAD_numc *(EAEEAD_pim/EAEEAD_gammaimcdag)^(1-EAE_mumc)
+EAERW_numc *(EAERW_pim/EAERW_gammaimcdag)^(1-EAE_mumc)
+EAEUS_numc *(EAEUS_pim/EAEUS_gammaimcdag)^(1-EAE_mumc)
+(1
-EAEEAA_numc
-EAEEAB_numc
-EAEEAD_numc
-EAERW_numc
-EAEUS_numc
)*(EAEEAC_pim/EAEEAC_gammaimcdag)^(1-EAE_mumc);
// Private consumption good (import) inflation
...
// Demand for bilateral consumption import goods
EAEEAB_imi = EAEEAB_numi*(EAEEAB_pim/(EAEEAB_gammaimidag*EAE_pimi))^(-EAE_mumi)*EAE_imi/(1-EAEEAB_gammaimi);
EAEUS_imi = EAEUS_numi*(EAEUS_pim/(EAEUS_gammaimidag*EAE_pimi))^(-EAE_mumi)*EAE_imi/(1-EAEUS_gammaimi);
EAEEAA_imi = EAEEAA_numi*(EAEEAA_pim/(EAEEAA_gammaimidag*EAE_pimi))^(-EAE_mumi)*EAE_imi/(1-EAEEAA_gammaimi);
EAEEAD_imi = EAEEAD_numi*(EAEEAD_pim/(EAEEAD_gammaimidag*EAE_pimi))^(-EAE_mumi)*EAE_imi/(1-EAEEAD_gammaimi);
EAEEAC_imi = (1
-EAEEAA_numi
-EAEEAB_numi
-EAEEAD_numi
-EAERW_numi
-EAEUS_numi
)*(EAEEAC_pim/(EAEEAC_gammaimidag*EAE_pimi))^(-EAE_mumi)*EAE_imi/(1-EAEEAC_gammaimi);
// Price of the consumption good (import)
EAE_pimi^(1-EAE_mumi) =
+EAEEAA_numi *(EAEEAA_pim/EAEEAA_gammaimidag)^(1-EAE_mumi)
+EAEEAB_numi *(EAEEAB_pim/EAEEAB_gammaimidag)^(1-EAE_mumi)
+EAEEAD_numi *(EAEEAD_pim/EAEEAD_gammaimidag)^(1-EAE_mumi)
+EAERW_numi *(EAERW_pim/EAERW_gammaimidag)^(1-EAE_mumi)
+EAEUS_numi *(EAEUS_pim/EAEUS_gammaimidag)^(1-EAE_mumi)
+(1
-EAEEAA_numi
-EAEEAB_numi
-EAEEAD_numi
-EAERW_numi
-EAEUS_numi
)*(EAEEAC_pim/EAEEAC_gammaimidag)^(1-EAE_mumi);
// Private consumption good (import) inflation
...
// Demand for bilateral consumption import goods
EAEEAB_imcg = EAEEAB_numcg*(EAEEAB_pim/(EAEEAB_gammaimcgdag*EAE_pimcg))^(-EAE_mumcg)*EAE_imcg/(1-EAEEAB_gammaimcg);
EAEUS_imcg = EAEUS_numcg*(EAEUS_pim/(EAEUS_gammaimcgdag*EAE_pimcg))^(-EAE_mumcg)*EAE_imcg/(1-EAEUS_gammaimcg);
EAEEAA_imcg = EAEEAA_numcg*(EAEEAA_pim/(EAEEAA_gammaimcgdag*EAE_pimcg))^(-EAE_mumcg)*EAE_imcg/(1-EAEEAA_gammaimcg);
EAEEAD_imcg = EAEEAD_numcg*(EAEEAD_pim/(EAEEAD_gammaimcgdag*EAE_pimcg))^(-EAE_mumcg)*EAE_imcg/(1-EAEEAD_gammaimcg);
EAEEAC_imcg = (1
-EAEEAA_numcg
-EAEEAB_numcg
-EAEEAD_numcg
-EAERW_numcg
-EAEUS_numcg
)*(EAEEAC_pim/(EAEEAC_gammaimcgdag*EAE_pimcg))^(-EAE_mumcg)*EAE_imcg/(1-EAEEAC_gammaimcg);
// Price of the consumption good (import)
EAE_pimcg^(1-EAE_mumcg) =
+EAEEAA_numcg *(EAEEAA_pim/EAEEAA_gammaimcgdag)^(1-EAE_mumcg)
+EAEEAB_numcg *(EAEEAB_pim/EAEEAB_gammaimcgdag)^(1-EAE_mumcg)
+EAEEAD_numcg *(EAEEAD_pim/EAEEAD_gammaimcgdag)^(1-EAE_mumcg)
+EAERW_numcg *(EAERW_pim/EAERW_gammaimcgdag)^(1-EAE_mumcg)
+EAEUS_numcg *(EAEUS_pim/EAEUS_gammaimcgdag)^(1-EAE_mumcg)
+(1
-EAEEAA_numcg
-EAEEAB_numcg
-EAEEAD_numcg
-EAERW_numcg
-EAEUS_numcg
)*(EAEEAC_pim/EAEEAC_gammaimcgdag)^(1-EAE_mumcg);
// Private consumption good (import) inflation
...
// Demand for bilateral consumption import goods
EAEEAB_imig = EAEEAB_numig*(EAEEAB_pim/(EAEEAB_gammaimigdag*EAE_pimig))^(-EAE_mumig)*EAE_imig/(1-EAEEAB_gammaimig);
EAEUS_imig = EAEUS_numig*(EAEUS_pim/(EAEUS_gammaimigdag*EAE_pimig))^(-EAE_mumig)*EAE_imig/(1-EAEUS_gammaimig);
EAEEAA_imig = EAEEAA_numig*(EAEEAA_pim/(EAEEAA_gammaimigdag*EAE_pimig))^(-EAE_mumig)*EAE_imig/(1-EAEEAA_gammaimig);
EAEEAD_imig = EAEEAD_numig*(EAEEAD_pim/(EAEEAD_gammaimigdag*EAE_pimig))^(-EAE_mumig)*EAE_imig/(1-EAEEAD_gammaimig);
EAEEAC_imig = (1
-EAEEAA_numig
-EAEEAB_numig
-EAEEAD_numig
-EAERW_numig
-EAEUS_numig
)*(EAEEAC_pim/(EAEEAC_gammaimigdag*EAE_pimig))^(-EAE_mumig)*EAE_imig/(1-EAEEAC_gammaimig);
// Price of the consumption good (import)
EAE_pimig^(1-EAE_mumig) =
+EAEEAA_numig *(EAEEAA_pim/EAEEAA_gammaimigdag)^(1-EAE_mumig)
+EAEEAB_numig *(EAEEAB_pim/EAEEAB_gammaimigdag)^(1-EAE_mumig)
+EAEEAD_numig *(EAEEAD_pim/EAEEAD_gammaimigdag)^(1-EAE_mumig)
+EAERW_numig *(EAERW_pim/EAERW_gammaimigdag)^(1-EAE_mumig)
+EAEUS_numig *(EAEUS_pim/EAEUS_gammaimigdag)^(1-EAE_mumig)
+(1
-EAEEAA_numig
-EAEEAB_numig
-EAEEAD_numig
-EAERW_numig
-EAEUS_numig
)*(EAEEAC_pim/EAEEAC_gammaimigdag)^(1-EAE_mumig);
// Private consumption good (import) inflation
...
+EAE_pig*EAE_qig
+EAEEAA_rer*EAAEAE_pim*EAA_size/EAE_size*EAAEAE_im
-EAEEAA_pim*(EAEEAA_imc*(1-EAEEAA_gammaimc)/EAEEAA_gammaimcdag)
-EAEEAA_pim*(EAEEAA_imi*(1-EAEEAA_gammaimi)/EAEEAA_gammaimidag)
-EAEEAA_pim*EAEEAA_imcg
-EAEEAA_pim*EAEEAA_imig
+EAEEAB_rer*EABEAE_pim*EAB_size/EAE_size*EABEAE_im
-EAEEAB_pim*(EAEEAB_imc*(1-EAEEAB_gammaimc)/EAEEAB_gammaimcdag)
-EAEEAB_pim*(EAEEAB_imi*(1-EAEEAB_gammaimi)/EAEEAB_gammaimidag)
-EAEEAB_pim*EAEEAB_imcg
-EAEEAB_pim*EAEEAB_imig
+EAEEAC_rer*EACEAE_pim*EAC_size/EAE_size*EACEAE_im
-EAEEAC_pim*(EAEEAC_imc*(1-EAEEAC_gammaimc)/EAEEAC_gammaimcdag)
-EAEEAC_pim*(EAEEAC_imi*(1-EAEEAC_gammaimi)/EAEEAC_gammaimidag)
-EAEEAC_pim*EAEEAC_imcg
-EAEEAC_pim*EAEEAC_imig
+EAEEAD_rer*EADEAE_pim*EAD_size/EAE_size*EADEAE_im
-EAEEAD_pim*(EAEEAD_imc*(1-EAEEAD_gammaimc)/EAEEAD_gammaimcdag)
-EAEEAD_pim*(EAEEAD_imi*(1-EAEEAD_gammaimi)/EAEEAD_gammaimidag)
-EAEEAD_pim*EAEEAD_imcg
-EAEEAD_pim*EAEEAD_imig
+EAERW_rer*RWEAE_pim*RW_size/EAE_size*RWEAE_im
-EAERW_pim*(EAERW_imc*(1-EAERW_gammaimc)/EAERW_gammaimcdag)
-EAERW_pim*(EAERW_imi*(1-EAERW_gammaimi)/EAERW_gammaimidag)
-EAERW_pim*EAERW_imcg
-EAERW_pim*EAERW_imig
+EAEUS_rer*USEAE_pim*US_size/EAE_size*USEAE_im
-EAEUS_pim*(EAEUS_imc*(1-EAEUS_gammaimc)/EAEUS_gammaimcdag)
-EAEUS_pim*(EAEUS_imi*(1-EAEUS_gammaimi)/EAEUS_gammaimidag)
...
RWEAE_imc = RWEAE_numc*(RWEAE_pim/(RWEAE_gammaimcdag*RW_pimc))^(-RW_mumc)*RW_imc/(1-RWEAE_gammaimc);
RWEAD_imc = (1
-RWEAA_numc
-RWEAB_numc
-RWEAC_numc
-RWEAE_numc
-RWUS_numc
)*(RWEAD_pim/(RWEAD_gammaimcdag*RW_pimc))^(-RW_mumc)*RW_imc/(1-RWEAD_gammaimc);
// Price of the consumption good (import)
RW_pimc^(1-RW_mumc) =
...
+RWEAE_numc *(RWEAE_pim/RWEAE_gammaimcdag)^(1-RW_mumc)
...
-RWEAE_numc
-RWUS_numc
)*(RWEAD_pim/RWEAD_gammaimcdag)^(1-RW_mumc);
// Private consumption good (import) inflation
...
RWEAE_imi = RWEAE_numi*(RWEAE_pim/(RWEAE_gammaimidag*RW_pimi))^(-RW_mumi)*RW_imi/(1-RWEAE_gammaimi);
RWEAD_imi = (1
-RWEAA_numi
-RWEAB_numi
-RWEAC_numi
-RWEAE_numi
-RWUS_numi
)*(RWEAD_pim/(RWEAD_gammaimidag*RW_pimi))^(-RW_mumi)*RW_imi/(1-RWEAD_gammaimi);
// Price of the consumption good (import)
RW_pimi^(1-RW_mumi) =
...
+RWEAE_numi *(RWEAE_pim/RWEAE_gammaimidag)^(1-RW_mumi)
...
-RWEAE_numi
-RWUS_numi
)*(RWEAD_pim/RWEAD_gammaimidag)^(1-RW_mumi);
// Private consumption good (import) inflation
...
// Demand for bilateral consumption import goods
RWEAC_imcg = RWEAC_numcg*(RWEAC_pim/(RWEAC_gammaimcgdag*RW_pimcg))^(-RW_mumcg)*RW_imcg/(1-RWEAC_gammaimcg);
RWEAA_imcg = RWEAA_numcg*(RWEAA_pim/(RWEAA_gammaimcgdag*RW_pimcg))^(-RW_mumcg)*RW_imcg/(1-RWEAA_gammaimcg);
RWEAB_imcg = RWEAB_numcg*(RWEAB_pim/(RWEAB_gammaimcgdag*RW_pimcg))^(-RW_mumcg)*RW_imcg/(1-RWEAB_gammaimcg);
RWEAE_imcg = RWEAE_numcg*(RWEAE_pim/(RWEAE_gammaimcgdag*RW_pimcg))^(-RW_mumcg)*RW_imcg/(1-RWEAE_gammaimcg);
RWEAD_imcg = (1
-RWEAA_numcg
-RWEAB_numcg
-RWEAC_numcg
-RWEAE_numcg
-RWUS_numcg
)*(RWEAD_pim/(RWEAD_gammaimcgdag*RW_pimcg))^(-RW_mumcg)*RW_imcg/(1-RWEAD_gammaimcg);
// Price of the consumption good (import)
RW_pimcg^(1-RW_mumcg) =
+RWEAA_numcg *(RWEAA_pim/RWEAA_gammaimcgdag)^(1-RW_mumcg)
+RWEAB_numcg *(RWEAB_pim/RWEAB_gammaimcgdag)^(1-RW_mumcg)
+RWEAC_numcg *(RWEAC_pim/RWEAC_gammaimcgdag)^(1-RW_mumcg)
+RWEAE_numcg *(RWEAE_pim/RWEAE_gammaimcgdag)^(1-RW_mumcg)
+RWUS_numcg *(RWUS_pim/RWUS_gammaimcgdag)^(1-RW_mumcg)
+(1
-RWEAA_numcg
-RWEAB_numcg
-RWEAC_numcg
-RWEAE_numcg
-RWUS_numcg
)*(RWEAD_pim/RWEAD_gammaimcgdag)^(1-RW_mumcg);
// Private consumption good (import) inflation
...
// Demand for bilateral consumption import goods
RWEAC_imig = RWEAC_numig*(RWEAC_pim/(RWEAC_gammaimigdag*RW_pimig))^(-RW_mumig)*RW_imig/(1-RWEAC_gammaimig);
RWEAA_imig = RWEAA_numig*(RWEAA_pim/(RWEAA_gammaimigdag*RW_pimig))^(-RW_mumig)*RW_imig/(1-RWEAA_gammaimig);
RWEAB_imig = RWEAB_numig*(RWEAB_pim/(RWEAB_gammaimigdag*RW_pimig))^(-RW_mumig)*RW_imig/(1-RWEAB_gammaimig);
RWEAE_imig = RWEAE_numig*(RWEAE_pim/(RWEAE_gammaimigdag*RW_pimig))^(-RW_mumig)*RW_imig/(1-RWEAE_gammaimig);
RWEAD_imig = (1
-RWEAA_numig
-RWEAB_numig
-RWEAC_numig
-RWEAE_numig
-RWUS_numig
)*(RWEAD_pim/(RWEAD_gammaimigdag*RW_pimig))^(-RW_mumig)*RW_imig/(1-RWEAD_gammaimig);
// Price of the consumption good (import)
RW_pimig^(1-RW_mumig) =
+RWEAA_numig *(RWEAA_pim/RWEAA_gammaimigdag)^(1-RW_mumig)
+RWEAB_numig *(RWEAB_pim/RWEAB_gammaimigdag)^(1-RW_mumig)
+RWEAC_numig *(RWEAC_pim/RWEAC_gammaimigdag)^(1-RW_mumig)
+RWEAE_numig *(RWEAE_pim/RWEAE_gammaimigdag)^(1-RW_mumig)
+RWUS_numig *(RWUS_pim/RWUS_gammaimigdag)^(1-RW_mumig)
+(1
-RWEAA_numig
-RWEAB_numig
-RWEAC_numig
-RWEAE_numig
-RWUS_numig
)*(RWEAD_pim/RWEAD_gammaimigdag)^(1-RW_mumig);
// Private consumption good (import) inflation
...
+RWEAD_rer*EADRW_pim*EAD_size/RW_size*EADRW_im
-RWEAD_pim*(RWEAD_imc*(1-RWEAD_gammaimc)/RWEAD_gammaimcdag)
-RWEAD_pim*(RWEAD_imi*(1-RWEAD_gammaimi)/RWEAD_gammaimidag)
-RWEAD_pim*RWEAD_imcg
-RWEAD_pim*RWEAD_imig
+RWEAE_rer*EAERW_pim*EAE_size/RW_size*EAERW_im
-RWEAE_pim*(RWEAE_imc*(1-RWEAE_gammaimc)/RWEAE_gammaimcdag)
-RWEAE_pim*(RWEAE_imi*(1-RWEAE_gammaimi)/RWEAE_gammaimidag)
...
// Demand for bilateral consumption import goods
USEAD_imc = USEAD_numc*(USEAD_pim/(USEAD_gammaimcdag*US_pimc))^(-US_mumc)*US_imc/(1-USEAD_gammaimc);
USEAB_imc = USEAB_numc*(USEAB_pim/(USEAB_gammaimcdag*US_pimc))^(-US_mumc)*US_imc/(1-USEAB_gammaimc);
USEAC_imc = USEAC_numc*(USEAC_pim/(USEAC_gammaimcdag*US_pimc))^(-US_mumc)*US_imc/(1-USEAC_gammaimc);
...
-USEAD_numc
-USRW_numc
)*(USEAE_pim/(USEAE_gammaimcdag*US_pimc))^(-US_mumc)*US_imc/(1-USEAE_gammaimc);
// Price of the consumption good (import)
US_pimc^(1-US_mumc) =
+USEAA_numc *(USEAA_pim/USEAA_gammaimcdag)^(1-US_mumc)
+USEAB_numc *(USEAB_pim/USEAB_gammaimcdag)^(1-US_mumc)
+USEAC_numc *(USEAC_pim/USEAC_gammaimcdag)^(1-US_mumc)
+USEAD_numc *(USEAD_pim/USEAD_gammaimcdag)^(1-US_mumc)
...
-USEAD_numc
-USRW_numc
)*(USEAE_pim/USEAE_gammaimcdag)^(1-US_mumc);
// Private consumption good (import) inflation
...
// Demand for bilateral consumption import goods
USEAD_imi = USEAD_numi*(USEAD_pim/(USEAD_gammaimidag*US_pimi))^(-US_mumi)*US_imi/(1-USEAD_gammaimi);
USEAB_imi = USEAB_numi*(USEAB_pim/(USEAB_gammaimidag*US_pimi))^(-US_mumi)*US_imi/(1-USEAB_gammaimi);
USEAC_imi = USEAC_numi*(USEAC_pim/(USEAC_gammaimidag*US_pimi))^(-US_mumi)*US_imi/(1-USEAC_gammaimi);
...
-USEAD_numi
-USRW_numi
)*(USEAE_pim/(USEAE_gammaimidag*US_pimi))^(-US_mumi)*US_imi/(1-USEAE_gammaimi);
// Price of the consumption good (import)
US_pimi^(1-US_mumi) =
+USEAA_numi *(USEAA_pim/USEAA_gammaimidag)^(1-US_mumi)
+USEAB_numi *(USEAB_pim/USEAB_gammaimidag)^(1-US_mumi)
+USEAC_numi *(USEAC_pim/USEAC_gammaimidag)^(1-US_mumi)
+USEAD_numi *(USEAD_pim/USEAD_gammaimidag)^(1-US_mumi)
...
-USEAD_numi
-USRW_numi
)*(USEAE_pim/USEAE_gammaimidag)^(1-US_mumi);
// Private consumption good (import) inflation
...
// Demand for bilateral consumption import goods
USEAD_imcg = USEAD_numcg*(USEAD_pim/(USEAD_gammaimcgdag*US_pimcg))^(-US_mumcg)*US_imcg/(1-USEAD_gammaimcg);
USEAB_imcg = USEAB_numcg*(USEAB_pim/(USEAB_gammaimcgdag*US_pimcg))^(-US_mumcg)*US_imcg/(1-USEAB_gammaimcg);
USEAC_imcg = USEAC_numcg*(USEAC_pim/(USEAC_gammaimcgdag*US_pimcg))^(-US_mumcg)*US_imcg/(1-USEAC_gammaimcg);
USRW_imcg = USRW_numcg*(USRW_pim/(USRW_gammaimcgdag*US_pimcg))^(-US_mumcg)*US_imcg/(1-USRW_gammaimcg);
USEAE_imcg = (1
-USEAA_numcg
-USEAB_numcg
-USEAC_numcg
-USEAD_numcg
-USRW_numcg
)*(USEAE_pim/(USEAE_gammaimcgdag*US_pimcg))^(-US_mumcg)*US_imcg/(1-USEAE_gammaimcg);
// Price of the consumption good (import)
US_pimcg^(1-US_mumcg) =
+USEAA_numcg *(USEAA_pim/USEAA_gammaimcgdag)^(1-US_mumcg)
+USEAB_numcg *(USEAB_pim/USEAB_gammaimcgdag)^(1-US_mumcg)
+USEAC_numcg *(USEAC_pim/USEAC_gammaimcgdag)^(1-US_mumcg)
+USEAD_numcg *(USEAD_pim/USEAD_gammaimcgdag)^(1-US_mumcg)
+USRW_numcg *(USRW_pim/USRW_gammaimcgdag)^(1-US_mumcg)
+(1
-USEAA_numcg
-USEAB_numcg
-USEAC_numcg
-USEAD_numcg
-USRW_numcg
)*(USEAE_pim/USEAE_gammaimcgdag)^(1-US_mumcg);
// Private consumption good (import) inflation
...
// Demand for bilateral consumption import goods
USEAD_imig = USEAD_numig*(USEAD_pim/(USEAD_gammaimigdag*US_pimig))^(-US_mumig)*US_imig/(1-USEAD_gammaimig);
USEAB_imig = USEAB_numig*(USEAB_pim/(USEAB_gammaimigdag*US_pimig))^(-US_mumig)*US_imig/(1-USEAB_gammaimig);
USEAC_imig = USEAC_numig*(USEAC_pim/(USEAC_gammaimigdag*US_pimig))^(-US_mumig)*US_imig/(1-USEAC_gammaimig);
USRW_imig = USRW_numig*(USRW_pim/(USRW_gammaimigdag*US_pimig))^(-US_mumig)*US_imig/(1-USRW_gammaimig);
USEAE_imig = (1
-USEAA_numig
-USEAB_numig
-USEAC_numig
-USEAD_numig
-USRW_numig
)*(USEAE_pim/(USEAE_gammaimigdag*US_pimig))^(-US_mumig)*US_imig/(1-USEAE_gammaimig);
// Price of the consumption good (import)
US_pimig^(1-US_mumig) =
+USEAA_numig *(USEAA_pim/USEAA_gammaimigdag)^(1-US_mumig)
+USEAB_numig *(USEAB_pim/USEAB_gammaimigdag)^(1-US_mumig)
+USEAC_numig *(USEAC_pim/USEAC_gammaimigdag)^(1-US_mumig)
+USEAD_numig *(USEAD_pim/USEAD_gammaimigdag)^(1-US_mumig)
+USRW_numig *(USRW_pim/USRW_gammaimigdag)^(1-US_mumig)
+(1
-USEAA_numig
-USEAB_numig
-USEAC_numig
-USEAD_numig
-USRW_numig
)*(USEAE_pim/USEAE_gammaimigdag)^(1-US_mumig);
// Private consumption good (import) inflation
...
+USEAD_rer*EADUS_pim*EAD_size/US_size*EADUS_im
-USEAD_pim*(USEAD_imc*(1-USEAD_gammaimc)/USEAD_gammaimcdag)
-USEAD_pim*(USEAD_imi*(1-USEAD_gammaimi)/USEAD_gammaimidag)
-USEAD_pim*USEAD_imcg
-USEAD_pim*USEAD_imig
+USEAE_rer*EAEUS_pim*EAE_size/US_size*EAEUS_im
-USEAE_pim*(USEAE_imc*(1-USEAE_gammaimc)/USEAE_gammaimcdag)
-USEAE_pim*(USEAE_imi*(1-USEAE_gammaimi)/USEAE_gammaimidag)
