function [y, T] = dynamic_237(y, x, params, steady_state, sparse_rowval, sparse_colval, sparse_colptr, T)
  ...
  T(8163)=params(611)*(y(4271)/y(12560))^(-params(616))*(y(12490)/T(2235))^params(616);
  y(12528)=(1-params(611))*(y(12561)/y(12560))^(-params(616))+T(8163)*y(4239);
  y(12477)=y(12473)*y(12528);
  y(8827)=y(8721);
  y(10151)=T(909)*y(10137)/T(2398);
  y(10123)=T(909)*y(10109)/T(2398);
end
