...
residual=NaN(5, 1);
  residual(1)=(y(6270))-(y(6269));
  residual(2)=(y(6269))-(y(5523));
  T(82)=params(1087)^(-1);
  residual(3)=(y(5552))-(T(82)*y(5523));
  residual(4)=(y(5524))-(y(5523)*y(5523)*y(6269)*y(6270));
  T(83)=y(5552)^4-1;
...
if nargout > 3
    g1_v = NaN(12, 1);
g1_v(1)=1;
g1_v(2)=(-(y(5523)*y(5523)*y(6269)));
g1_v(3)=(-1);
g1_v(4)=1;
g1_v(5)=(-(y(5523)*y(5523)*y(6270)));
g1_v(6)=1;
g1_v(7)=T(84)-params(1130)*T(84);
g1_v(8)=(-1);
g1_v(9)=(-T(82));
g1_v(10)=(-(y(6270)*y(6269)*(y(5523)+y(5523))));
g1_v(11)=1;
