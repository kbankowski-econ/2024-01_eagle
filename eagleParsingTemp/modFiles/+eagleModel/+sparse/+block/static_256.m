...
residual=NaN(5, 1);
  residual(1)=(y(7104))-(y(7103));
  residual(2)=(y(7103))-(y(6792));
  residual(3)=(y(6793))-(y(6792)*y(6792)*y(7103)*y(7104));
  T(61)=y(6821)^4-1;
...
g1_v(1)=(-1);
g1_v(2)=1;
g1_v(3)=(-(y(6792)*y(6792)*y(7104)));
g1_v(4)=(-1);
g1_v(5)=(-(y(7104)*y(7103)*(y(6792)+y(6792))));
g1_v(6)=(-T(62));
g1_v(7)=1;
g1_v(8)=(-(y(6792)*y(6792)*y(7103)));
g1_v(9)=1;
