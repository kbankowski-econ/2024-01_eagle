...
residual=NaN(5, 1);
  residual(1)=(y(4112))-(y(4111));
  residual(2)=(y(4111))-(y(3868));
  residual(3)=(y(3869))-(y(3868)*y(3868)*y(4111)*y(4112));
  T(45)=y(3897)^4-1;
...
if nargout > 3
    g1_v = NaN(12, 1);
g1_v(1)=1;
g1_v(2)=(-(y(3868)*y(3868)*y(4111)));
g1_v(3)=(-1);
g1_v(4)=1;
g1_v(5)=(-(y(3868)*y(3868)*y(4112)));
g1_v(6)=(-1);
g1_v(7)=(-(y(4112)*y(4111)*(y(3868)+y(3868))));
g1_v(8)=(-T(46));
g1_v(9)=1;
