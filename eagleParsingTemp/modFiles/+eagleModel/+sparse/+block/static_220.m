...
residual=NaN(5, 1);
  residual(1)=(y(5512))-(y(5511));
  residual(2)=(y(5511))-(y(5234));
  residual(3)=(y(5235))-(y(5234)*y(5234)*y(5511)*y(5512));
  T(53)=y(5263)^4-1;
...
g1_v(1)=(-1);
g1_v(2)=1;
g1_v(3)=(-(y(5234)*y(5234)*y(5512)));
g1_v(4)=(-1);
g1_v(5)=(-(y(5512)*y(5511)*(y(5234)+y(5234))));
g1_v(6)=(-T(54));
g1_v(7)=1;
g1_v(8)=(-(y(5234)*y(5234)*y(5511)));
g1_v(9)=1;
