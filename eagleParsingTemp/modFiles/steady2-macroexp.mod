...
;
// Flip variables
change_type(parameters) EAA_epsilonm EAA_vi EAA_iy EAA_imcy EAA_imiy;
change_type(var) EAA_gammav2 EAA_gammav1 EAA_taukbar EAA_nutc EAA_nuti;
change_type(parameters) EAB_epsilonm EAB_vi EAB_iy EAB_imcy EAB_imiy;
change_type(var) EAB_gammav2 EAB_gammav1 EAB_taukbar EAB_nutc EAB_nuti;
change_type(parameters) EAC_epsilonm EAC_vi EAC_iy EAC_imcy EAC_imiy;
change_type(var) EAC_gammav2 EAC_gammav1 EAC_taukbar EAC_nutc EAC_nuti;
change_type(parameters) EAD_epsilonm EAD_vi EAD_iy EAD_imcy EAD_imiy;
change_type(var) EAD_gammav2 EAD_gammav1 EAD_taukbar EAD_nutc EAD_nuti;
change_type(parameters) EAE_epsilonm EAE_vi EAE_iy EAE_imcy EAE_imiy;
change_type(var) EAE_gammav2 EAE_gammav1 EAE_taukbar EAE_nutc EAE_nuti;
change_type(parameters) RW_epsilonm RW_vi RW_iy RW_imcy RW_imiy;
change_type(var) RW_gammav2 RW_gammav1 RW_taukbar RW_nutc RW_nuti;
change_type(parameters) US_epsilonm US_vi US_iy US_imcy US_imiy;
change_type(var) US_gammav2 US_gammav1 US_taukbar US_nutc US_nuti;
change_type(parameters) EAAEAB_imcy EAAEAB_imiy;
change_type(var) EAAEAB_numc EAAEAB_numi;
change_type(parameters) EAAEAC_imcy EAAEAC_imiy;
change_type(var) EAAEAC_numc EAAEAC_numi;
change_type(parameters) EAAEAD_imcy EAAEAD_imiy;
change_type(var) EAAEAD_numc EAAEAD_numi;
change_type(parameters) EAAEAE_imcy EAAEAE_imiy;
change_type(var) EAAEAE_numc EAAEAE_numi;
change_type(parameters) EAAUS_imcy EAAUS_imiy;
change_type(var) EAAUS_numc EAAUS_numi;
change_type(parameters) EABEAA_imcy EABEAA_imiy;
change_type(var) EABEAA_numc EABEAA_numi;
change_type(parameters) EABEAC_imcy EABEAC_imiy;
change_type(var) EABEAC_numc EABEAC_numi;
change_type(parameters) EABEAD_imcy EABEAD_imiy;
change_type(var) EABEAD_numc EABEAD_numi;
change_type(parameters) EABEAE_imcy EABEAE_imiy;
change_type(var) EABEAE_numc EABEAE_numi;
change_type(parameters) EABRW_imcy EABRW_imiy;
change_type(var) EABRW_numc EABRW_numi;
change_type(parameters) EACEAB_imcy EACEAB_imiy;
change_type(var) EACEAB_numc EACEAB_numi;
change_type(parameters) EACEAD_imcy EACEAD_imiy;
change_type(var) EACEAD_numc EACEAD_numi;
change_type(parameters) EACEAE_imcy EACEAE_imiy;
change_type(var) EACEAE_numc EACEAE_numi;
change_type(parameters) EACRW_imcy EACRW_imiy;
change_type(var) EACRW_numc EACRW_numi;
change_type(parameters) EACUS_imcy EACUS_imiy;
change_type(var) EACUS_numc EACUS_numi;
change_type(parameters) EADEAA_imcy EADEAA_imiy;
change_type(var) EADEAA_numc EADEAA_numi;
change_type(parameters) EADEAC_imcy EADEAC_imiy;
change_type(var) EADEAC_numc EADEAC_numi;
change_type(parameters) EADEAE_imcy EADEAE_imiy;
change_type(var) EADEAE_numc EADEAE_numi;
change_type(parameters) EADRW_imcy EADRW_imiy;
change_type(var) EADRW_numc EADRW_numi;
change_type(parameters) EADUS_imcy EADUS_imiy;
change_type(var) EADUS_numc EADUS_numi;
change_type(parameters) EAEEAA_imcy EAEEAA_imiy;
change_type(var) EAEEAA_numc EAEEAA_numi;
change_type(parameters) EAEEAB_imcy EAEEAB_imiy;
change_type(var) EAEEAB_numc EAEEAB_numi;
change_type(parameters) EAEEAD_imcy EAEEAD_imiy;
change_type(var) EAEEAD_numc EAEEAD_numi;
change_type(parameters) EAERW_imcy EAERW_imiy;
change_type(var) EAERW_numc EAERW_numi;
change_type(parameters) EAEUS_imcy EAEUS_imiy;
change_type(var) EAEUS_numc EAEUS_numi;
change_type(parameters) RWEAA_imcy RWEAA_imiy;
change_type(var) RWEAA_numc RWEAA_numi;
change_type(parameters) RWEAB_imcy RWEAB_imiy;
change_type(var) RWEAB_numc RWEAB_numi;
change_type(parameters) RWEAC_imcy RWEAC_imiy;
change_type(var) RWEAC_numc RWEAC_numi;
change_type(parameters) RWEAE_imcy RWEAE_imiy;
change_type(var) RWEAE_numc RWEAE_numi;
change_type(parameters) RWUS_imcy RWUS_imiy;
change_type(var) RWUS_numc RWUS_numi;
change_type(parameters) USEAA_imcy USEAA_imiy;
change_type(var) USEAA_numc USEAA_numi;
change_type(parameters) USEAB_imcy USEAB_imiy;
change_type(var) USEAB_numc USEAB_numi;
change_type(parameters) USEAC_imcy USEAC_imiy;
change_type(var) USEAC_numc USEAC_numi;
change_type(parameters) USEAD_imcy USEAD_imiy;
change_type(var) USEAD_numc USEAD_numi;
change_type(parameters) USRW_imcy USRW_imiy;
change_type(var) USRW_numc USRW_numi;
