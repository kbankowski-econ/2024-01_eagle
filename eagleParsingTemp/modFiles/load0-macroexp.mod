...
US_igy = 0.01/10;
  ...
  EAA_imigy = EAA_pimig*EAA_imig/(EAA_py*EAA_y);
      ...
      EAARW_imcy = 0.09;
        EAARW_imi = 0.0003;
        EAARW_imiy = 0.0008;
        EAARW_imcg = EAARW_numcg*(EAARW_pim/EAA_pimcg)^(-EAA_mumcg)*EAA_imcg;
        EAARW_imcgy = EAARW_pim*EAARW_imcg/(EAA_py*EAA_y);
        EAARW_imig = EAARW_numig*(EAARW_pim/EAA_pimig)^(-EAA_mumig)*EAA_imig;
        EAARW_imigy = EAARW_pim*EAARW_imig/(EAA_py*EAA_y);
      EAAUS_imc = 0.02;
      EAAUS_imcy = 0.09;
        EAAUS_imi = 0.0003;
  ...
  EAB_imigy = EAB_pimig*EAB_imig/(EAB_py*EAB_y);
      ...
      EABEAC_imcy = 0.09;
        EABEAC_imi = 0.0003;
        EABEAC_imiy = 0.0008;
        EABEAC_imcg = EABEAC_numcg*(EABEAC_pim/EAB_pimcg)^(-EAB_mumcg)*EAB_imcg;
        EABEAC_imcgy = EABEAC_pim*EABEAC_imcg/(EAB_py*EAB_y);
        EABEAC_imig = EABEAC_numig*(EABEAC_pim/EAB_pimig)^(-EAB_mumig)*EAB_imig;
        EABEAC_imigy = EABEAC_pim*EABEAC_imig/(EAB_py*EAB_y);
      EABEAD_imc = 0.02;
      EABEAD_imcy = 0.09;
        EABEAD_imi = 0.0003;
      ...
      EABUS_imcy = 0.09;
        EABUS_imi = 0.0003;
        EABUS_imiy = 0.0008;
        EABUS_imcg = EABUS_numcg*(EABUS_pim/EAB_pimcg)^(-EAB_mumcg)*EAB_imcg;
        EABUS_imcgy = EABUS_pim*EABUS_imcg/(EAB_py*EAB_y);
        EABUS_imig = EABUS_numig*(EABUS_pim/EAB_pimig)^(-EAB_mumig)*EAB_imig;
        EABUS_imigy = EABUS_pim*EABUS_imig/(EAB_py*EAB_y);
  ...
  EAC_imigy = EAC_pimig*EAC_imig/(EAC_py*EAC_y);
      ...
      EACEAA_imcy = 0.09;
        EACEAA_imi = 0.0003;
        EACEAA_imiy = 0.0008;
        EACEAA_imcg = EACEAA_numcg*(EACEAA_pim/EAC_pimcg)^(-EAC_mumcg)*EAC_imcg;
        EACEAA_imcgy = EACEAA_pim*EACEAA_imcg/(EAC_py*EAC_y);
        EACEAA_imig = EACEAA_numig*(EACEAA_pim/EAC_pimig)^(-EAC_mumig)*EAC_imig;
        EACEAA_imigy = EACEAA_pim*EACEAA_imig/(EAC_py*EAC_y);
      EACEAB_imc = 0.02;
      EACEAB_imcy = 0.09;
        EACEAB_imi = 0.0003;
      ...
      EACEAD_imcy = 0.09;
        EACEAD_imi = 0.0003;
        EACEAD_imiy = 0.0008;
        EACEAD_imcg = EACEAD_numcg*(EACEAD_pim/EAC_pimcg)^(-EAC_mumcg)*EAC_imcg;
        EACEAD_imcgy = EACEAD_pim*EACEAD_imcg/(EAC_py*EAC_y);
        EACEAD_imig = EACEAD_numig*(EACEAD_pim/EAC_pimig)^(-EAC_mumig)*EAC_imig;
        EACEAD_imigy = EACEAD_pim*EACEAD_imig/(EAC_py*EAC_y);
      EACEAE_imc = 0.02;
      EACEAE_imcy = 0.09;
        EACEAE_imi = 0.0003;
  ...
  EAD_imigy = EAD_pimig*EAD_imig/(EAD_py*EAD_y);
      ...
      EADEAB_imcy = 0.09;
        EADEAB_imi = 0.0003;
        EADEAB_imiy = 0.0008;
        EADEAB_imcg = EADEAB_numcg*(EADEAB_pim/EAD_pimcg)^(-EAD_mumcg)*EAD_imcg;
        EADEAB_imcgy = EADEAB_pim*EADEAB_imcg/(EAD_py*EAD_y);
        EADEAB_imig = EADEAB_numig*(EADEAB_pim/EAD_pimig)^(-EAD_mumig)*EAD_imig;
        EADEAB_imigy = EADEAB_pim*EADEAB_imig/(EAD_py*EAD_y);
      EADEAC_imc = 0.02;
      EADEAC_imcy = 0.09;
        EADEAC_imi = 0.0003;
      ...
      EADEAE_imcy = 0.09;
        EADEAE_imi = 0.0003;
        EADEAE_imiy = 0.0008;
        EADEAE_imcg = EADEAE_numcg*(EADEAE_pim/EAD_pimcg)^(-EAD_mumcg)*EAD_imcg;
        EADEAE_imcgy = EADEAE_pim*EADEAE_imcg/(EAD_py*EAD_y);
        EADEAE_imig = EADEAE_numig*(EADEAE_pim/EAD_pimig)^(-EAD_mumig)*EAD_imig;
        EADEAE_imigy = EADEAE_pim*EADEAE_imig/(EAD_py*EAD_y);
      EADRW_imc = 0.02;
      EADRW_imcy = 0.09;
        EADRW_imi = 0.0003;
  ...
  EAE_imigy = EAE_pimig*EAE_imig/(EAE_py*EAE_y);
      ...
      EAEEAC_imcy = 0.09;
        EAEEAC_imi = 0.0003;
        EAEEAC_imiy = 0.0008;
        EAEEAC_imcg = EAEEAC_numcg*(EAEEAC_pim/EAE_pimcg)^(-EAE_mumcg)*EAE_imcg;
        EAEEAC_imcgy = EAEEAC_pim*EAEEAC_imcg/(EAE_py*EAE_y);
        EAEEAC_imig = EAEEAC_numig*(EAEEAC_pim/EAE_pimig)^(-EAE_mumig)*EAE_imig;
        EAEEAC_imigy = EAEEAC_pim*EAEEAC_imig/(EAE_py*EAE_y);
      EAEEAD_imc = 0.02;
      EAEEAD_imcy = 0.09;
        EAEEAD_imi = 0.0003;
      ...
      EAERW_imcy = 0.09;
        EAERW_imi = 0.0003;
        EAERW_imiy = 0.0008;
        EAERW_imcg = EAERW_numcg*(EAERW_pim/EAE_pimcg)^(-EAE_mumcg)*EAE_imcg;
        EAERW_imcgy = EAERW_pim*EAERW_imcg/(EAE_py*EAE_y);
        EAERW_imig = EAERW_numig*(EAERW_pim/EAE_pimig)^(-EAE_mumig)*EAE_imig;
        EAERW_imigy = EAERW_pim*EAERW_imig/(EAE_py*EAE_y);
      EAEUS_imc = 0.02;
      EAEUS_imcy = 0.09;
        EAEUS_imi = 0.0003;
  ...
  RW_imigy = RW_pimig*RW_imig/(RW_py*RW_y);
      ...
      RWEAD_imcy = 0.09;
        RWEAD_imi = 0.0003;
        RWEAD_imiy = 0.0008;
        RWEAD_imcg = RWEAD_numcg*(RWEAD_pim/RW_pimcg)^(-RW_mumcg)*RW_imcg;
        RWEAD_imcgy = RWEAD_pim*RWEAD_imcg/(RW_py*RW_y);
        RWEAD_imig = RWEAD_numig*(RWEAD_pim/RW_pimig)^(-RW_mumig)*RW_imig;
        RWEAD_imigy = RWEAD_pim*RWEAD_imig/(RW_py*RW_y);
      RWEAE_imc = 0.02;
      RWEAE_imcy = 0.09;
        RWEAE_imi = 0.0003;
  ...
  US_imigy = US_pimig*US_imig/(US_py*US_y);
      ...
      USEAE_imcy = 0.09;
        USEAE_imi = 0.0003;
        USEAE_imiy = 0.0008;
        USEAE_imcg = USEAE_numcg*(USEAE_pim/US_pimcg)^(-US_mumcg)*US_imcg;
        USEAE_imcgy = USEAE_pim*USEAE_imcg/(US_py*US_y);
        USEAE_imig = USEAE_numig*(USEAE_pim/US_pimig)^(-US_mumig)*US_imig;
        USEAE_imigy = USEAE_pim*USEAE_imig/(US_py*US_y);
      USRW_imc = 0.02;
      USRW_imcy = 0.09;
        USRW_imi = 0.0003;
