...
residual=NaN(5, 1);
  residual(1)=(y(2944))-(y(2943));
  residual(2)=(y(2943))-(y(2694));
  T(53)=params(663)^(-1);
  residual(3)=(y(2723))-(T(53)*y(2694));
  residual(4)=(y(2695))-(y(2694)*y(2694)*y(2943)*y(2944));
  T(54)=y(2723)^4-1;
...
if nargout > 3
    g1_v = NaN(12, 1);
g1_v(1)=1;
g1_v(2)=(-(y(2694)*y(2694)*y(2943)));
g1_v(3)=(-1);
g1_v(4)=1;
g1_v(5)=(-(y(2694)*y(2694)*y(2944)));
g1_v(6)=1;
g1_v(7)=T(55)-params(703)*T(55);
g1_v(8)=(-1);
g1_v(9)=(-T(53));
g1_v(10)=(-(y(2944)*y(2943)*(y(2694)+y(2694))));
g1_v(11)=1;
