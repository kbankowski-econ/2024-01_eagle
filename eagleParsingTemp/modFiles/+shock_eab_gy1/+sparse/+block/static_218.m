...
residual=NaN(5, 1);
  residual(1)=(y(5558))-(y(5557));
  residual(2)=(y(5557))-(y(4792));
  T(50)=params(979)^(-1);
  ...
  residual(5)=(y(4793))-(y(4792)*y(4792)*y(5557)*y(5558));
  T(52)=4*y(4821)^3;
if nargout > 3
    g1_v = NaN(12, 1);
g1_v(1)=(-1);
g1_v(2)=1;
g1_v(3)=(-(y(4792)*y(4792)*y(5558)));
g1_v(4)=(-1);
g1_v(5)=(-T(50));
g1_v(6)=(-(y(5558)*y(5557)*(y(4792)+y(4792))));
g1_v(7)=1;
g1_v(8)=T(52)-params(1022)*T(52);
g1_v(9)=(-((1-params(1022))*params(1021)));
g1_v(10)=1;
g1_v(11)=1;
g1_v(12)=(-(y(4792)*y(4792)*y(5557)));
