...
residual=NaN(5, 1);
  residual(1)=(y(2575))-(y(2574));
  residual(2)=(y(2574))-(y(2043));
  residual(3)=(y(2044))-(y(2043)*y(2043)*y(2574)*y(2575));
  T(30)=y(2072)^4-1;
...
g1_v(1)=(-1);
g1_v(2)=1;
g1_v(3)=(-(y(2043)*y(2043)*y(2575)));
g1_v(4)=(-1);
g1_v(5)=(-(y(2575)*y(2574)*(y(2043)+y(2043))));
g1_v(6)=(-T(31));
g1_v(7)=1;
g1_v(8)=(-(y(2043)*y(2043)*y(2574)));
g1_v(9)=1;
