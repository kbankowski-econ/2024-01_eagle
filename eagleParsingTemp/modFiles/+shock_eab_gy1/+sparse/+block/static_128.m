...
residual=NaN(5, 1);
  residual(1)=(y(2393))-(y(2392));
  residual(2)=(y(2392))-(y(1857));
  residual(3)=(y(1858))-(y(1857)*y(1857)*y(2392)*y(2393));
  T(30)=y(1886)^4-1;
...
if nargout > 3
    g1_v = NaN(12, 1);
g1_v(1)=1;
g1_v(2)=(-(y(1857)*y(1857)*y(2392)));
g1_v(3)=(-1);
g1_v(4)=1;
g1_v(5)=(-(y(1857)*y(1857)*y(2393)));
g1_v(6)=(-1);
g1_v(7)=(-(y(2393)*y(2392)*(y(1857)+y(1857))));
g1_v(8)=(-T(31));
g1_v(9)=1;
