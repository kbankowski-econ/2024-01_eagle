...
residual=NaN(5, 1);
  residual(1)=(y(4148))-(y(4147));
  residual(2)=(y(4147))-(y(3474));
  residual(3)=(y(3475))-(y(3474)*y(3474)*y(4147)*y(4148));
  T(42)=y(3503)^4-1;
...
g1_v(1)=(-1);
g1_v(2)=1;
g1_v(3)=(-(y(3474)*y(3474)*y(4148)));
g1_v(4)=(-1);
g1_v(5)=(-(y(4148)*y(4147)*(y(3474)+y(3474))));
g1_v(6)=(-T(43));
g1_v(7)=1;
g1_v(8)=(-(y(3474)*y(3474)*y(4147)));
g1_v(9)=1;
