...
residual=NaN(5, 1);
  residual(1)=(y(1463))-(y(1462));
  residual(2)=(y(1462))-(y(1019));
  T(22)=params(279)^(-1);
  ...
  residual(5)=(y(1020))-(y(1019)*y(1019)*y(1462)*y(1463));
  T(24)=4*y(1048)^3;
if nargout > 3
    g1_v = NaN(12, 1);
g1_v(1)=(-1);
g1_v(2)=1;
g1_v(3)=(-(y(1019)*y(1019)*y(1463)));
g1_v(4)=(-1);
g1_v(5)=(-T(22));
g1_v(6)=(-(y(1463)*y(1462)*(y(1019)+y(1019))));
g1_v(7)=1;
g1_v(8)=T(24)-params(322)*T(24);
g1_v(9)=(-((1-params(322))*params(321)));
g1_v(10)=1;
g1_v(11)=1;
g1_v(12)=(-(y(1019)*y(1019)*y(1462)));
