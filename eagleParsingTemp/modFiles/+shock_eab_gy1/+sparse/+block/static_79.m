...
residual=NaN(5, 1);
  residual(1)=(y(1070))-(y(1069));
  residual(2)=(y(1069))-(y(672));
  T(24)=params(187)^(-1);
  ...
  residual(5)=(y(673))-(y(672)*y(672)*y(1069)*y(1070));
  T(26)=4*y(701)^3;
if nargout > 3
    g1_v = NaN(12, 1);
g1_v(1)=(-1);
g1_v(2)=1;
g1_v(3)=(-(y(672)*y(672)*y(1070)));
g1_v(4)=(-1);
g1_v(5)=(-T(24));
g1_v(6)=(-(y(1070)*y(1069)*(y(672)+y(672))));
g1_v(7)=1;
g1_v(8)=T(26)-params(230)*T(26);
g1_v(9)=(-((1-params(230))*params(229)));
g1_v(10)=1;
g1_v(11)=1;
g1_v(12)=(-(y(672)*y(672)*y(1069)));
