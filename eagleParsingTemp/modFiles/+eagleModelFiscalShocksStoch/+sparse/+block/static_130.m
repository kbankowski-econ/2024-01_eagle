...
residual=NaN(5, 1);
  residual(1)=(y(2624))-(y(2623));
  residual(2)=(y(2623))-(y(2396));
  T(33)=params(564)^(-1);
  residual(3)=(y(2425))-(y(2396)*T(33));
  residual(4)=(y(2397))-(y(2396)*y(2396)*y(2623)*y(2624));
  T(34)=y(2425)^4-1;
...
g1_v(1)=(-1);
g1_v(2)=1;
g1_v(3)=(-(y(2396)*y(2396)*y(2624)));
g1_v(4)=(-1);
g1_v(5)=(-T(33));
g1_v(6)=(-(y(2624)*y(2623)*(y(2396)+y(2396))));
g1_v(7)=1;
g1_v(8)=T(35)-params(604)*T(35);
g1_v(9)=1;
g1_v(10)=(-(y(2396)*y(2396)*y(2623)));
g1_v(11)=1;
