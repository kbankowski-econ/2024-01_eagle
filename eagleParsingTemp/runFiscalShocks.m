...
aEndoVar = "EA_y";
endoStruct.(aEndoVar) = Series(qq(0, 4), reshape(fiscalSimOutput.oo_.endo_simul(strcmp(aEndoVar, fiscalSimOutput.M_.endo_names),:), [], 1));
ssStruct.(aEndoVar) = Series(qq(0, 4), repmat(fiscalSimOutput.oo_.steady_state(strcmp(aEndoVar, fiscalSimOutput.M_.endo_names)), 102, 1));
