...
countries = ["EAA", "EAB","EAC","EAD","EAE","EAF", "RW", "US"];
countriesResidual = [countries(7) , countries(8) , countries(1) , countries(2), countries(3), countries(4), countries(5), countries(6)];
