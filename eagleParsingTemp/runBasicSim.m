...
function insertInTextFile(originalFileName, newFileName, linesToInsert, lineNumber, linesToInsert2, lineNumber2, linesToInsert3, lineNumber3, linesToInsert4, lineNumber4)
    ...
    % Insert the lines after line 104
    % Ensure there are at least 104 lines to avoid indexing errors
    if numel(fileLines) >= lineNumber
        modifiedLines = [ ...
            fileLines(1:lineNumber) ...
            ; linesToInsert ...
            ; fileLines(lineNumber+1:lineNumber2) ...
            ; linesToInsert2 ...
            ; fileLines(lineNumber2+1:lineNumber3) ...
            ; linesToInsert3 ...
            ; fileLines(lineNumber3+1:lineNumber4) ...
            ; linesToInsert4 ...
            ; fileLines(lineNumber4+1:end) ...
        ];
    else
        error('The file does not have enough lines to perform the insertion.');
    end
    
    % Combine the lines back into a single string
    newContent = strjoin(modifiedLines, newline);
