...
countriesResidual = [countries(13), countries(14), countries(1), countries(2) , countries(3) , countries(4) , countries(5), countries(6), countries(7), countries(8), countries(9), countries(10), countries(11), countries(12)];
...
sizes = struct(...
    ...
    'EAJ_size', 0.03834611, ...
    'EAK_size', 0.00676711, ...
    'EAL_size', 0.05315326+0.00034567, ...
    'RW_size', 0.470000, ...
    'US_size', 0.310000);
...
countriesResidual = [countries(13), countries(14), countries(1), countries(2) , countries(3) , countries(4) , countries(5), countries(6), countries(7), countries(8), countries(9), countries(10), countries(11), countries(12)];
sizes = struct(...
    'EAA_size', 0.005150154, ...
    'EAB_size', 0.005057796, ...
    'EAC_size', 0.006299306, ...
    'EAD_size', 0.016743862, ...
    'EAE_size', 0.003103176, ...
    'EAF_size', 0.033586493, ...
    'EAG_size', 0.002762291, ...
    'EAH_size', 0.003952069, ...
    'EAI_size', 0.025277958, ...
    'EAJ_size', 0.010136191, ...
    'EAK_size', 0.002834446, ...
    'EAL_size', 0.044367384, ...
    'RW_size', 0.601923611, ...
    'US_size', 0.238805263);
...
%%
copyfile(...
    '/Users/kk/Documents/0000-00_work/2024-01_eagle/eagleParsingTemp/modFiles/steady2b-macroexp.mod' ...
