...
load(sprintf("%s/eagleParsingTemp/modFiles/steady2b/Output/steady2b_results_temp3.mat", project_path));
...
save(sprintf("%s/eagleParsingTemp/modFiles/steady2b/Output/steady2b_results_temp4.mat", project_path), 'oo_', 'M_', 'options_');
