...
load(sprintf("%s/eagleParsingTemp/modFiles/steady2b/Output/steady2b_results_temp5.mat", project_path));
...
% 
% tempStruc.temp0 = load(sprintf("%s/eagleParsingTemp/modFiles/steady2a/Output/steady2a_results_temp0.mat", project_path), 'oo_');
...
save(sprintf("%s/eagleParsingTemp/modFiles/steady2b/Output/steady2b_results_temp6.mat", project_path), 'oo_', 'M_', 'options_');
