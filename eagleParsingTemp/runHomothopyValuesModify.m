...
for aItem = ["imcy", "imcgy", "imiy", "imigy", "rer"]
    ...
    writetable(tableForXls.(aItem), xlsFilePath, 'Sheet', 'calibRW4', 'Range', rangeStruct.(aItem), 'WriteRowNames', true, 'WriteVariableNames', true);
end
...
for aItem = ["y", "py", "size", "pex"]
    ...
    writetable(tableFlatForXls.(aItem), xlsFilePath, 'Sheet', 'calibRW4', 'Range', rangeFlatStruct.(aItem), 'WriteRowNames', true, 'WriteVariableNames', true);
end
