...
// CES consumption bundle for each type of household:
    @{co}_ccesi^(1-1/@{co}_mucces) = (@{co}_nucces)^(1/@{co}_mucces)*@{co}_ci^(1-1/@{co}_mucces)+(1-@{co}_nucces)^(1/@{co}_mucces)*@{co}_g^(1-1/@{co}_mucces);
    @{co}_ccesj^(1-1/@{co}_mucces) = (@{co}_nucces)^(1/@{co}_mucces)*@{co}_cj^(1-1/@{co}_mucces)+(1-@{co}_nucces)^(1/@{co}_mucces)*@{co}_g^(1-1/@{co}_mucces);
...
@{co}_dcci = ((@{co}_nucces)^(1/@{co}_mucces)*@{co}_ci^(1-1/@{co}_mucces)+(1-@{co}_nucces)^(1/@{co}_mucces)*@{co}_g^(1-1/@{co}_mucces))^(1/(@{co}_mucces-1))*(@{co}_nucces^(1/@{co}_mucces))*(@{co}_ci^(-1/@{co}_mucces));
...
// Marginal utility of consumption
@{co}_dccj = ((@{co}_nucces)^(1/@{co}_mucces)*@{co}_cj^(1-1/@{co}_mucces)+(1-@{co}_nucces)^(1/@{co}_mucces)*@{co}_g^(1-1/@{co}_mucces))^(1/(@{co}_mucces-1))*(@{co}_nucces^(1/@{co}_mucces))*(@{co}_cj^(-1/@{co}_mucces));
