...
log(U2_T_GO_SBCN) = log(U2_T_GO_SBCN(-1)) + 0.1*(log(U2_GO_Y_OSBCN/100)-log(U2_T_GO_SBCN(-1)/U2_T_YEN(-1)))  // added smoothing of gdp
...
log(U2_T_GO_PUR) = log(U2_T_GO_PUR(-1)) + 0.1 * (log(U2_GO_Y_OPUN/100)-(log(U2_T_GO_PUR(-1)*U2_HH_COD(-1))-log(U2_T_YEN(-1))))
...
log(U2_T_GO_SIN) = log(U2_T_GO_SIN(-1)) + 0.1 * (log(U2_GO_Y_OSIN/100)-log(U2_T_GO_SIN(-1)/U2_T_YEN(-1)))
                                      + log(U2_T_YEN/U2_T_YEN(-1))  
...
log(U2_T_GO_CER)= log(U2_T_GO_CER(-1)) + 0.1*(log(U2_GO_Y_OCEN/100)-log(U2_GO_CEN(-1)/U2_T_YEN(-1)))
...
log(U2_T_GO_ITR)= log(U2_T_GO_ITR(-1)) + 0.1*(log(U2_GO_Y_OITN / 100)-(log(U2_T_GO_ITR(-1)*U2_GO_ITD(-1))-log(U2_T_YEN(-1)))) // Added smoothing
...
U2_GO_REN  = U2_GO_Y_OREN / 100 * U2_T_YEN + res_U2_GO_REN;
